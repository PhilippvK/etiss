...
partInit.code() += "etiss_uint32 offs = *((RV32IMACFDPV*)cpu)->X[" + std::to_string(rs1 % 32U) + "U] + " + std::to_string(((etiss_int16)((imm) << (4)) >> (4))) + ";\n";
...
partInit.code() += "((RV32IMACFDPV*)cpu)->F[" + std::to_string(rd) + "U] = res;\n";
...
partInit.code() += "etiss_uint32 offs = *((RV32IMACFDPV*)cpu)->X[" + std::to_string(rs1 % 32U) + "U] + " + std::to_string(((etiss_int16)((imm) << (4)) >> (4))) + ";\n";
partInit.code() += "etiss_uint64 mem_val_0;\n";
partInit.code() += "mem_val_0 = (etiss_uint64)(((RV32IMACFDPV*)cpu)->F[" + std::to_string(rs2) + "U]);\n";
...
// -----------------------------------------------------------------------------
partInit.code() += "cpu->nextPc = " + std::to_string(ic.current_address_ + 4U) + "U;\n";
partInit.code() += "etiss_uint64 res = fmadd_d((etiss_uint64)(((RV32IMACFDPV*)cpu)->F[" + std::to_string(rs1) + "U]), (etiss_uint64)(((RV32IMACFDPV*)cpu)->F[" + std::to_string(rs2) + "U]), (etiss_uint64)(((RV32IMACFDPV*)cpu)->F[" + std::to_string(rs3) + "U]), 0U, (" + std::to_string(rm < 7U) + "U) ? (" + std::to_string(rm) + "U) : ((etiss_uint8)(((RV32IMACFDPV*)cpu)->FCSR)));\n";
partInit.code() += "((RV32IMACFDPV*)cpu)->F[" + std::to_string(rd) + "U] = res;\n";
partInit.code() += "etiss_uint32 flags = fget_flags();\n";
partInit.code() += "((RV32IMACFDPV*)cpu)->FCSR = (((RV32IMACFDPV*)cpu)->FCSR & -32) | (flags & 31U);\n";
partInit.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
partInit.code() += "cpu->instructionPointer = cpu->nextPc;\n";
// -----------------------------------------------------------------------------
...
// -----------------------------------------------------------------------------
partInit.code() += "cpu->nextPc = " + std::to_string(ic.current_address_ + 4U) + "U;\n";
partInit.code() += "etiss_uint64 res = fmadd_d((etiss_uint64)(((RV32IMACFDPV*)cpu)->F[" + std::to_string(rs1) + "U]), (etiss_uint64)(((RV32IMACFDPV*)cpu)->F[" + std::to_string(rs2) + "U]), (etiss_uint64)(((RV32IMACFDPV*)cpu)->F[" + std::to_string(rs3) + "U]), 1U, (" + std::to_string(rm < 7U) + "U) ? (" + std::to_string(rm) + "U) : ((etiss_uint8)(((RV32IMACFDPV*)cpu)->FCSR)));\n";
partInit.code() += "((RV32IMACFDPV*)cpu)->F[" + std::to_string(rd) + "U] = res;\n";
partInit.code() += "etiss_uint32 flags = fget_flags();\n";
partInit.code() += "((RV32IMACFDPV*)cpu)->FCSR = (((RV32IMACFDPV*)cpu)->FCSR & -32) | (flags & 31U);\n";
partInit.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
...
// -----------------------------------------------------------------------------
partInit.code() += "cpu->nextPc = " + std::to_string(ic.current_address_ + 4U) + "U;\n";
partInit.code() += "etiss_uint64 res = fmadd_d((etiss_uint64)(((RV32IMACFDPV*)cpu)->F[" + std::to_string(rs1) + "U]), (etiss_uint64)(((RV32IMACFDPV*)cpu)->F[" + std::to_string(rs2) + "U]), (etiss_uint64)(((RV32IMACFDPV*)cpu)->F[" + std::to_string(rs3) + "U]), 2U, (" + std::to_string(rm < 7U) + "U) ? (" + std::to_string(rm) + "U) : ((etiss_uint8)(((RV32IMACFDPV*)cpu)->FCSR)));\n";
partInit.code() += "((RV32IMACFDPV*)cpu)->F[" + std::to_string(rd) + "U] = res;\n";
partInit.code() += "etiss_uint32 flags = fget_flags();\n";
partInit.code() += "((RV32IMACFDPV*)cpu)->FCSR = (((RV32IMACFDPV*)cpu)->FCSR & -32) | (flags & 31U);\n";
partInit.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
...
// -----------------------------------------------------------------------------
partInit.code() += "cpu->nextPc = " + std::to_string(ic.current_address_ + 4U) + "U;\n";
partInit.code() += "etiss_uint64 res = fmadd_d((etiss_uint64)(((RV32IMACFDPV*)cpu)->F[" + std::to_string(rs1) + "U]), (etiss_uint64)(((RV32IMACFDPV*)cpu)->F[" + std::to_string(rs2) + "U]), (etiss_uint64)(((RV32IMACFDPV*)cpu)->F[" + std::to_string(rs3) + "U]), 3U, (" + std::to_string(rm < 7U) + "U) ? (" + std::to_string(rm) + "U) : ((etiss_uint8)(((RV32IMACFDPV*)cpu)->FCSR)));\n";
partInit.code() += "((RV32IMACFDPV*)cpu)->F[" + std::to_string(rd) + "U] = res;\n";
partInit.code() += "etiss_uint32 flags = fget_flags();\n";
partInit.code() += "((RV32IMACFDPV*)cpu)->FCSR = (((RV32IMACFDPV*)cpu)->FCSR & -32) | (flags & 31U);\n";
partInit.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
...
// -----------------------------------------------------------------------------
partInit.code() += "cpu->nextPc = " + std::to_string(ic.current_address_ + 4U) + "U;\n";
partInit.code() += "etiss_uint64 res = fadd_d((etiss_uint64)(((RV32IMACFDPV*)cpu)->F[" + std::to_string(rs1) + "U]), (etiss_uint64)(((RV32IMACFDPV*)cpu)->F[" + std::to_string(rs2) + "U]), (" + std::to_string(rm < 7U) + "U) ? (" + std::to_string(rm) + "U) : ((etiss_uint8)(((RV32IMACFDPV*)cpu)->FCSR)));\n";
partInit.code() += "((RV32IMACFDPV*)cpu)->F[" + std::to_string(rd) + "U] = res;\n";
partInit.code() += "etiss_uint32 flags = fget_flags();\n";
partInit.code() += "((RV32IMACFDPV*)cpu)->FCSR = (((RV32IMACFDPV*)cpu)->FCSR & -32) | (flags & 31U);\n";
partInit.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
...
// -----------------------------------------------------------------------------
partInit.code() += "cpu->nextPc = " + std::to_string(ic.current_address_ + 4U) + "U;\n";
partInit.code() += "etiss_uint64 res = fsub_d((etiss_uint64)(((RV32IMACFDPV*)cpu)->F[" + std::to_string(rs1) + "U]), (etiss_uint64)(((RV32IMACFDPV*)cpu)->F[" + std::to_string(rs2) + "U]), (" + std::to_string(rm < 7U) + "U) ? (" + std::to_string(rm) + "U) : ((etiss_uint8)(((RV32IMACFDPV*)cpu)->FCSR)));\n";
partInit.code() += "((RV32IMACFDPV*)cpu)->F[" + std::to_string(rd) + "U] = res;\n";
partInit.code() += "etiss_uint32 flags = fget_flags();\n";
partInit.code() += "((RV32IMACFDPV*)cpu)->FCSR = (((RV32IMACFDPV*)cpu)->FCSR & -32) | (flags & 31U);\n";
partInit.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
...
// -----------------------------------------------------------------------------
partInit.code() += "cpu->nextPc = " + std::to_string(ic.current_address_ + 4U) + "U;\n";
partInit.code() += "etiss_uint64 res = fmul_d((etiss_uint64)(((RV32IMACFDPV*)cpu)->F[" + std::to_string(rs1) + "U]), (etiss_uint64)(((RV32IMACFDPV*)cpu)->F[" + std::to_string(rs2) + "U]), (" + std::to_string(rm < 7U) + "U) ? (" + std::to_string(rm) + "U) : ((etiss_uint8)(((RV32IMACFDPV*)cpu)->FCSR)));\n";
partInit.code() += "((RV32IMACFDPV*)cpu)->F[" + std::to_string(rd) + "U] = res;\n";
partInit.code() += "etiss_uint32 flags = fget_flags();\n";
partInit.code() += "((RV32IMACFDPV*)cpu)->FCSR = (((RV32IMACFDPV*)cpu)->FCSR & -32) | (flags & 31U);\n";
partInit.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
...
// -----------------------------------------------------------------------------
partInit.code() += "cpu->nextPc = " + std::to_string(ic.current_address_ + 4U) + "U;\n";
partInit.code() += "etiss_uint64 res = fdiv_d((etiss_uint64)(((RV32IMACFDPV*)cpu)->F[" + std::to_string(rs1) + "U]), (etiss_uint64)(((RV32IMACFDPV*)cpu)->F[" + std::to_string(rs2) + "U]), (" + std::to_string(rm < 7U) + "U) ? (" + std::to_string(rm) + "U) : ((etiss_uint8)(((RV32IMACFDPV*)cpu)->FCSR)));\n";
partInit.code() += "((RV32IMACFDPV*)cpu)->F[" + std::to_string(rd) + "U] = res;\n";
partInit.code() += "etiss_uint32 flags = fget_flags();\n";
partInit.code() += "((RV32IMACFDPV*)cpu)->FCSR = (((RV32IMACFDPV*)cpu)->FCSR & -32) | (flags & 31U);\n";
partInit.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
...
// -----------------------------------------------------------------------------
partInit.code() += "cpu->nextPc = " + std::to_string(ic.current_address_ + 4U) + "U;\n";
partInit.code() += "etiss_uint64 res = fsqrt_d((etiss_uint64)(((RV32IMACFDPV*)cpu)->F[" + std::to_string(rs1) + "U]), (" + std::to_string(rm < 7U) + "U) ? (" + std::to_string(rm) + "U) : ((etiss_uint8)(((RV32IMACFDPV*)cpu)->FCSR)));\n";
partInit.code() += "((RV32IMACFDPV*)cpu)->F[" + std::to_string(rd) + "U] = res;\n";
partInit.code() += "etiss_uint32 flags = fget_flags();\n";
partInit.code() += "((RV32IMACFDPV*)cpu)->FCSR = (((RV32IMACFDPV*)cpu)->FCSR & -32) | (flags & 31U);\n";
partInit.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
...
// -----------------------------------------------------------------------------
partInit.code() += "cpu->nextPc = " + std::to_string(ic.current_address_ + 4U) + "U;\n";
partInit.code() += "etiss_uint64 res = ((((((((RV32IMACFDPV*)cpu)->F[" + std::to_string(rs2) + "U]) >> (63U)) & 1)) << 63) | ((((((RV32IMACFDPV*)cpu)->F[" + std::to_string(rs1) + "U]) >> (0U)) & 9223372036854775807)));\n";
partInit.code() += "((RV32IMACFDPV*)cpu)->F[" + std::to_string(rd) + "U] = res;\n";
partInit.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
partInit.code() += "cpu->instructionPointer = cpu->nextPc;\n";
// -----------------------------------------------------------------------------
...
// -----------------------------------------------------------------------------
partInit.code() += "cpu->nextPc = " + std::to_string(ic.current_address_ + 4U) + "U;\n";
partInit.code() += "etiss_uint64 res = (etiss_uint64)(((RV32IMACFDPV*)cpu)->F[" + std::to_string(rs1) + "U]) ^ ((etiss_uint64)(((RV32IMACFDPV*)cpu)->F[" + std::to_string(rs2) + "U]) & 9223372036854775808UL);\n";
partInit.code() += "((RV32IMACFDPV*)cpu)->F[" + std::to_string(rd) + "U] = res;\n";
partInit.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
partInit.code() += "cpu->instructionPointer = cpu->nextPc;\n";
// -----------------------------------------------------------------------------
...
// -----------------------------------------------------------------------------
partInit.code() += "cpu->nextPc = " + std::to_string(ic.current_address_ + 4U) + "U;\n";
partInit.code() += "etiss_uint64 res = fsel_d((etiss_uint64)(((RV32IMACFDPV*)cpu)->F[" + std::to_string(rs1) + "U]), (etiss_uint64)(((RV32IMACFDPV*)cpu)->F[" + std::to_string(rs2) + "U]), 0U);\n";
partInit.code() += "((RV32IMACFDPV*)cpu)->F[" + std::to_string(rd) + "U] = res;\n";
partInit.code() += "etiss_uint32 flags = fget_flags();\n";
partInit.code() += "((RV32IMACFDPV*)cpu)->FCSR = (((RV32IMACFDPV*)cpu)->FCSR & -32) | (flags & 31U);\n";
partInit.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
...
// -----------------------------------------------------------------------------
partInit.code() += "cpu->nextPc = " + std::to_string(ic.current_address_ + 4U) + "U;\n";
partInit.code() += "etiss_uint64 res = fsel_d((etiss_uint64)(((RV32IMACFDPV*)cpu)->F[" + std::to_string(rs1) + "U]), (etiss_uint64)(((RV32IMACFDPV*)cpu)->F[" + std::to_string(rs2) + "U]), 1U);\n";
partInit.code() += "((RV32IMACFDPV*)cpu)->F[" + std::to_string(rd) + "U] = res;\n";
partInit.code() += "etiss_uint32 flags = fget_flags();\n";
partInit.code() += "((RV32IMACFDPV*)cpu)->FCSR = (((RV32IMACFDPV*)cpu)->FCSR & -32) | (flags & 31U);\n";
partInit.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
...
// -----------------------------------------------------------------------------
partInit.code() += "cpu->nextPc = " + std::to_string(ic.current_address_ + 4U) + "U;\n";
partInit.code() += "etiss_uint32 res = fconv_d2f(((RV32IMACFDPV*)cpu)->F[" + std::to_string(rs1) + "U], " + std::to_string(rm) + "U);\n";
partInit.code() += "((RV32IMACFDPV*)cpu)->F[" + std::to_string(rd) + "U] = -4294967296L + res;\n";
partInit.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
partInit.code() += "cpu->instructionPointer = cpu->nextPc;\n";
// -----------------------------------------------------------------------------
...
// -----------------------------------------------------------------------------
partInit.code() += "cpu->nextPc = " + std::to_string(ic.current_address_ + 4U) + "U;\n";
partInit.code() += "etiss_uint64 res = fconv_f2d((etiss_uint64)(((RV32IMACFDPV*)cpu)->F[" + std::to_string(rs1) + "U]), " + std::to_string(rm) + "U);\n";
partInit.code() += "((RV32IMACFDPV*)cpu)->F[" + std::to_string(rd) + "U] = res;\n";
partInit.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
partInit.code() += "cpu->instructionPointer = cpu->nextPc;\n";
// -----------------------------------------------------------------------------
...
partInit.code() += "res = fcmp_d(((RV32IMACFDPV*)cpu)->F[" + std::to_string(rs1) + "U], ((RV32IMACFDPV*)cpu)->F[" + std::to_string(rs2) + "U], 0U);\n";
if ((rd % 32U) != 0U) {
partInit.code() += "*((RV32IMACFDPV*)cpu)->X[" + std::to_string(rd % 32U) + "U] = res;\n";
}
partInit.code() += "etiss_uint32 flags = fget_flags();\n";
partInit.code() += "((RV32IMACFDPV*)cpu)->FCSR = (((RV32IMACFDPV*)cpu)->FCSR & -32) | (flags & 31U);\n";
partInit.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
...
partInit.code() += "cpu->nextPc = " + std::to_string(ic.current_address_ + 4U) + "U;\n";
partInit.code() += "etiss_uint64 res = 0U;\n";
partInit.code() += "res = fcmp_d(((RV32IMACFDPV*)cpu)->F[" + std::to_string(rs1) + "U], ((RV32IMACFDPV*)cpu)->F[" + std::to_string(rs2) + "U], 2U);\n";
if ((rd % 32U) != 0U) {
partInit.code() += "*((RV32IMACFDPV*)cpu)->X[" + std::to_string(rd % 32U) + "U] = res;\n";
}
partInit.code() += "etiss_uint32 flags = fget_flags();\n";
...
partInit.code() += "cpu->nextPc = " + std::to_string(ic.current_address_ + 4U) + "U;\n";
partInit.code() += "etiss_uint64 res = 0U;\n";
partInit.code() += "res = fcmp_d(((RV32IMACFDPV*)cpu)->F[" + std::to_string(rs1) + "U], ((RV32IMACFDPV*)cpu)->F[" + std::to_string(rs2) + "U], 1U);\n";
if ((rd % 32U) != 0U) {
partInit.code() += "*((RV32IMACFDPV*)cpu)->X[" + std::to_string(rd % 32U) + "U] = res;\n";
}
partInit.code() += "etiss_uint32 flags = fget_flags();\n";
...
// -----------------------------------------------------------------------------
partInit.code() += "cpu->nextPc = " + std::to_string(ic.current_address_ + 4U) + "U;\n";
partInit.code() += "*((RV32IMACFDPV*)cpu)->X[" + std::to_string(rd % 32U) + "U] = fclass_d((etiss_uint64)(((RV32IMACFDPV*)cpu)->F[" + std::to_string(rs1) + "U]));\n";
partInit.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
partInit.code() += "cpu->instructionPointer = cpu->nextPc;\n";
// -----------------------------------------------------------------------------
...
partInit.code() += "res = fcvt_64_32(((RV32IMACFDPV*)cpu)->F[" + std::to_string(rs1) + "U], 0U, " + std::to_string(rm) + "U);\n";
if ((rd % 32U) != 0U) {
partInit.code() += "*((RV32IMACFDPV*)cpu)->X[" + std::to_string(rd % 32U) + "U] = res;\n";
}
partInit.code() += "etiss_uint32 flags = fget_flags();\n";
...
partInit.code() += "res = fcvt_64_32(((RV32IMACFDPV*)cpu)->F[" + std::to_string(rs1) + "U], 1U, " + std::to_string(rm) + "U);\n";
if ((rd % 32U) != 0U) {
partInit.code() += "*((RV32IMACFDPV*)cpu)->X[" + std::to_string(rd % 32U) + "U] = (etiss_uint64)((etiss_int32)(res));\n";
}
partInit.code() += "etiss_uint32 flags = fget_flags();\n";
partInit.code() += "((RV32IMACFDPV*)cpu)->FCSR = (((RV32IMACFDPV*)cpu)->FCSR & -32) | (flags & 31U);\n";
partInit.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
...
// -----------------------------------------------------------------------------
partInit.code() += "cpu->nextPc = " + std::to_string(ic.current_address_ + 4U) + "U;\n";
partInit.code() += "etiss_int64 res = fcvt_32_64((etiss_uint32)(*((RV32IMACFDPV*)cpu)->X[" + std::to_string(rs1 % 32U) + "U]), 2U, " + std::to_string(rm) + "U);\n";
partInit.code() += "((RV32IMACFDPV*)cpu)->F[" + std::to_string(rd) + "U] = res;\n";
partInit.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
partInit.code() += "cpu->instructionPointer = cpu->nextPc;\n";
// -----------------------------------------------------------------------------
...
// -----------------------------------------------------------------------------
partInit.code() += "cpu->nextPc = " + std::to_string(ic.current_address_ + 4U) + "U;\n";
partInit.code() += "etiss_uint64 res = fcvt_32_64((etiss_uint32)(*((RV32IMACFDPV*)cpu)->X[" + std::to_string(rs1 % 32U) + "U]), 3U, " + std::to_string(rm) + "U);\n";
partInit.code() += "((RV32IMACFDPV*)cpu)->F[" + std::to_string(rd) + "U] = res;\n";
partInit.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
partInit.code() += "cpu->instructionPointer = cpu->nextPc;\n";
// -----------------------------------------------------------------------------
