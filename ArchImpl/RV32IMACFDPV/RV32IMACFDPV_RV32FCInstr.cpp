...
partInit.code() += "etiss_uint32 offs = *((RV32IMACFDPV*)cpu)->X[" + std::to_string(rs1 + 8U) + "U] + " + std::to_string(uimm) + "U;\n";
...
partInit.code() += "((RV32IMACFDPV*)cpu)->F[" + std::to_string(rd + 8U) + "U] = -4294967296L | res;\n";
...
partInit.code() += "etiss_uint32 offs = *((RV32IMACFDPV*)cpu)->X[" + std::to_string(rs1 + 8U) + "U] + " + std::to_string(uimm) + "U;\n";
partInit.code() += "etiss_uint32 mem_val_0;\n";
partInit.code() += "mem_val_0 = (etiss_uint32)(((RV32IMACFDPV*)cpu)->F[" + std::to_string(rs2 + 8U) + "U]);\n";
