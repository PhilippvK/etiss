...
partInit.code() += "((RV32IMACFDPV*)cpu)->F[" + std::to_string(rd) + "U] = -4294967296L | (etiss_uint64)(res);\n";
...
partInit.code() += "etiss_uint32 offs = *((RV32IMACFDPV*)cpu)->X[" + std::to_string(rs1 % 32U) + "U] + " + std::to_string(((etiss_int16)((imm) << (4)) >> (4))) + ";\n";
partInit.code() += "etiss_uint32 mem_val_0;\n";
partInit.code() += "mem_val_0 = (etiss_uint32)(((RV32IMACFDPV*)cpu)->F[" + std::to_string(rs2) + "U]);\n";
...
// -----------------------------------------------------------------------------
partInit.code() += "cpu->nextPc = " + std::to_string(ic.current_address_ + 4U) + "U;\n";
partInit.code() += "etiss_uint32 res = fmadd_s(unbox_s(((RV32IMACFDPV*)cpu)->F[" + std::to_string(rs1) + "U]), unbox_s(((RV32IMACFDPV*)cpu)->F[" + std::to_string(rs2) + "U]), unbox_s(((RV32IMACFDPV*)cpu)->F[" + std::to_string(rs3) + "U]), 0U, (" + std::to_string(rm < 7U) + "U) ? (" + std::to_string(rm) + "U) : ((etiss_uint8)(((RV32IMACFDPV*)cpu)->FCSR)));\n";
partInit.code() += "((RV32IMACFDPV*)cpu)->F[" + std::to_string(rd) + "U] = -4294967296L | (etiss_uint64)(res);\n";
...
// -----------------------------------------------------------------------------
partInit.code() += "cpu->nextPc = " + std::to_string(ic.current_address_ + 4U) + "U;\n";
partInit.code() += "etiss_uint32 res = fmadd_s(unbox_s(((RV32IMACFDPV*)cpu)->F[" + std::to_string(rs1) + "U]), unbox_s(((RV32IMACFDPV*)cpu)->F[" + std::to_string(rs2) + "U]), unbox_s(((RV32IMACFDPV*)cpu)->F[" + std::to_string(rs3) + "U]), 1U, (" + std::to_string(rm < 7U) + "U) ? (" + std::to_string(rm) + "U) : ((etiss_uint8)(((RV32IMACFDPV*)cpu)->FCSR)));\n";
partInit.code() += "((RV32IMACFDPV*)cpu)->F[" + std::to_string(rd) + "U] = -4294967296L | (etiss_uint64)(res);\n";
partInit.code() += "etiss_uint32 flags = fget_flags();\n";
partInit.code() += "((RV32IMACFDPV*)cpu)->FCSR = (((RV32IMACFDPV*)cpu)->FCSR & -32) | (flags & 31U);\n";
partInit.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
...
// -----------------------------------------------------------------------------
partInit.code() += "cpu->nextPc = " + std::to_string(ic.current_address_ + 4U) + "U;\n";
partInit.code() += "etiss_uint32 frs1 = unbox_s(((RV32IMACFDPV*)cpu)->F[" + std::to_string(rs1) + "U]);\n";
partInit.code() += "etiss_uint32 frs2 = unbox_s(((RV32IMACFDPV*)cpu)->F[" + std::to_string(rs2) + "U]);\n";
partInit.code() += "etiss_uint32 frs3 = unbox_s(((RV32IMACFDPV*)cpu)->F[" + std::to_string(rs3) + "U]);\n";
partInit.code() += "etiss_uint32 res = fmadd_s(frs1, frs2, frs3, 2U, (" + std::to_string(rm < 7U) + "U) ? (" + std::to_string(rm) + "U) : ((etiss_uint8)(((RV32IMACFDPV*)cpu)->FCSR)));\n";
partInit.code() += "((RV32IMACFDPV*)cpu)->F[" + std::to_string(rd) + "U] = -4294967296L | (etiss_uint64)(res);\n";
partInit.code() += "etiss_uint32 flags = fget_flags();\n";
partInit.code() += "((RV32IMACFDPV*)cpu)->FCSR = (((RV32IMACFDPV*)cpu)->FCSR & -32) | (flags & 31U);\n";
partInit.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
...
partInit.code() += "etiss_uint32 frs2 = unbox_s(((RV32IMACFDPV*)cpu)->F[" + std::to_string(rs2) + "U]);\n";
partInit.code() += "etiss_uint32 frs3 = unbox_s(((RV32IMACFDPV*)cpu)->F[" + std::to_string(rs3) + "U]);\n";
partInit.code() += "etiss_uint32 res = fmadd_s(frs1, frs2, frs3, 3U, (" + std::to_string(rm < 7U) + "U) ? (" + std::to_string(rm) + "U) : ((etiss_uint8)(((RV32IMACFDPV*)cpu)->FCSR)));\n";
partInit.code() += "((RV32IMACFDPV*)cpu)->F[" + std::to_string(rd) + "U] = -4294967296L | (etiss_uint64)(res);\n";
partInit.code() += "etiss_uint32 flags = fget_flags();\n";
partInit.code() += "((RV32IMACFDPV*)cpu)->FCSR = (((RV32IMACFDPV*)cpu)->FCSR & -32) | (flags & 31U);\n";
partInit.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
...
partInit.code() += "etiss_uint32 frs1 = unbox_s(((RV32IMACFDPV*)cpu)->F[" + std::to_string(rs1) + "U]);\n";
partInit.code() += "etiss_uint32 frs2 = unbox_s(((RV32IMACFDPV*)cpu)->F[" + std::to_string(rs2) + "U]);\n";
partInit.code() += "etiss_uint32 res = fadd_s(frs1, frs2, (" + std::to_string(rm < 7U) + "U) ? (" + std::to_string(rm) + "U) : ((etiss_uint8)(((RV32IMACFDPV*)cpu)->FCSR)));\n";
partInit.code() += "((RV32IMACFDPV*)cpu)->F[" + std::to_string(rd) + "U] = -4294967296L | (etiss_uint64)(res);\n";
partInit.code() += "etiss_uint32 flags = fget_flags();\n";
partInit.code() += "((RV32IMACFDPV*)cpu)->FCSR = (((RV32IMACFDPV*)cpu)->FCSR & -32) | (flags & 31U);\n";
partInit.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
...
partInit.code() += "etiss_uint32 frs1 = unbox_s(((RV32IMACFDPV*)cpu)->F[" + std::to_string(rs1) + "U]);\n";
partInit.code() += "etiss_uint32 frs2 = unbox_s(((RV32IMACFDPV*)cpu)->F[" + std::to_string(rs2) + "U]);\n";
partInit.code() += "etiss_uint32 res = fsub_s(frs1, frs2, (" + std::to_string(rm < 7U) + "U) ? (" + std::to_string(rm) + "U) : ((etiss_uint8)(((RV32IMACFDPV*)cpu)->FCSR)));\n";
partInit.code() += "((RV32IMACFDPV*)cpu)->F[" + std::to_string(rd) + "U] = -4294967296L | (etiss_uint64)(res);\n";
partInit.code() += "etiss_uint32 flags = fget_flags();\n";
partInit.code() += "((RV32IMACFDPV*)cpu)->FCSR = (((RV32IMACFDPV*)cpu)->FCSR & -32) | (flags & 31U);\n";
partInit.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
...
partInit.code() += "etiss_uint32 frs1 = unbox_s(((RV32IMACFDPV*)cpu)->F[" + std::to_string(rs1) + "U]);\n";
partInit.code() += "etiss_uint32 frs2 = unbox_s(((RV32IMACFDPV*)cpu)->F[" + std::to_string(rs2) + "U]);\n";
partInit.code() += "etiss_uint32 res = fmul_s(frs1, frs2, (" + std::to_string(rm < 7U) + "U) ? (" + std::to_string(rm) + "U) : ((etiss_uint8)(((RV32IMACFDPV*)cpu)->FCSR)));\n";
partInit.code() += "((RV32IMACFDPV*)cpu)->F[" + std::to_string(rd) + "U] = -4294967296L | (etiss_uint64)(res);\n";
partInit.code() += "etiss_uint32 flags = fget_flags();\n";
partInit.code() += "((RV32IMACFDPV*)cpu)->FCSR = (((RV32IMACFDPV*)cpu)->FCSR & -32) | (flags & 31U);\n";
partInit.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
...
partInit.code() += "etiss_uint32 frs1 = unbox_s(((RV32IMACFDPV*)cpu)->F[" + std::to_string(rs1) + "U]);\n";
partInit.code() += "etiss_uint32 frs2 = unbox_s(((RV32IMACFDPV*)cpu)->F[" + std::to_string(rs2) + "U]);\n";
partInit.code() += "etiss_uint32 res = fdiv_s(frs1, frs2, (" + std::to_string(rm < 7U) + "U) ? (" + std::to_string(rm) + "U) : ((etiss_uint8)(((RV32IMACFDPV*)cpu)->FCSR)));\n";
partInit.code() += "((RV32IMACFDPV*)cpu)->F[" + std::to_string(rd) + "U] = -4294967296L | (etiss_uint64)(res);\n";
partInit.code() += "etiss_uint32 flags = fget_flags();\n";
partInit.code() += "((RV32IMACFDPV*)cpu)->FCSR = (((RV32IMACFDPV*)cpu)->FCSR & -32) | (flags & 31U);\n";
partInit.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
...
partInit.code() += "cpu->nextPc = " + std::to_string(ic.current_address_ + 4U) + "U;\n";
partInit.code() += "etiss_uint32 frs1 = unbox_s(((RV32IMACFDPV*)cpu)->F[" + std::to_string(rs1) + "U]);\n";
partInit.code() += "etiss_uint32 res = fsqrt_s(frs1, (" + std::to_string(rm < 7U) + "U) ? (" + std::to_string(rm) + "U) : ((etiss_uint8)(((RV32IMACFDPV*)cpu)->FCSR)));\n";
partInit.code() += "((RV32IMACFDPV*)cpu)->F[" + std::to_string(rd) + "U] = -4294967296L | (etiss_uint64)(res);\n";
partInit.code() += "etiss_uint32 flags = fget_flags();\n";
partInit.code() += "((RV32IMACFDPV*)cpu)->FCSR = (((RV32IMACFDPV*)cpu)->FCSR & -32) | (flags & 31U);\n";
partInit.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
...
if ((rd % 32U) != 0U) {
partInit.code() += "*((RV32IMACFDPV*)cpu)->X[" + std::to_string(rd % 32U) + "U] = (etiss_uint32)((etiss_int32)(res));\n";
}
partInit.code() += "etiss_uint32 flags = fget_flags();\n";
partInit.code() += "((RV32IMACFDPV*)cpu)->FCSR = (((RV32IMACFDPV*)cpu)->FCSR & -32) | (flags & 31U);\n";
partInit.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
...
partInit.code() += "cpu->nextPc = " + std::to_string(ic.current_address_ + 4U) + "U;\n";
partInit.code() += "etiss_uint32 res = 0U;\n";
partInit.code() += "res = fclass_s(unbox_s(((RV32IMACFDPV*)cpu)->F[" + std::to_string(rs1) + "U]));\n";
if ((rd % 32U) != 0U) {
partInit.code() += "*((RV32IMACFDPV*)cpu)->X[" + std::to_string(rd % 32U) + "U] = res;\n";
}
partInit.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
...
// -----------------------------------------------------------------------------
partInit.code() += "cpu->nextPc = " + std::to_string(ic.current_address_ + 4U) + "U;\n";
partInit.code() += "etiss_uint32 res = fcvt_s((etiss_uint32)(*((RV32IMACFDPV*)cpu)->X[" + std::to_string(rs1 % 32U) + "U]), 2U, " + std::to_string(rm) + "U);\n";
partInit.code() += "((RV32IMACFDPV*)cpu)->F[" + std::to_string(rd) + "U] = -4294967296L | (etiss_uint64)(res);\n";
partInit.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
partInit.code() += "cpu->instructionPointer = cpu->nextPc;\n";
// -----------------------------------------------------------------------------
...
// -----------------------------------------------------------------------------
partInit.code() += "cpu->nextPc = " + std::to_string(ic.current_address_ + 4U) + "U;\n";
partInit.code() += "etiss_uint32 res = fcvt_s((etiss_uint32)(*((RV32IMACFDPV*)cpu)->X[" + std::to_string(rs1 % 32U) + "U]), 3U, " + std::to_string(rm) + "U);\n";
partInit.code() += "((RV32IMACFDPV*)cpu)->F[" + std::to_string(rd) + "U] = -4294967296L | (etiss_uint64)(res);\n";
partInit.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
partInit.code() += "cpu->instructionPointer = cpu->nextPc;\n";
// -----------------------------------------------------------------------------
...
partInit.code() += "cpu->nextPc = " + std::to_string(ic.current_address_ + 4U) + "U;\n";
if ((rd % 32U) != 0U) {
partInit.code() += "*((RV32IMACFDPV*)cpu)->X[" + std::to_string(rd % 32U) + "U] = (etiss_uint32)((etiss_int32)(((RV32IMACFDPV*)cpu)->F[" + std::to_string(rs1) + "U]));\n";
}
partInit.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
partInit.code() += "cpu->instructionPointer = cpu->nextPc;\n";
// -----------------------------------------------------------------------------
...
// -----------------------------------------------------------------------------
partInit.code() += "cpu->nextPc = " + std::to_string(ic.current_address_ + 4U) + "U;\n";
partInit.code() += "((RV32IMACFDPV*)cpu)->F[" + std::to_string(rd) + "U] = -4294967296L | (etiss_uint64)(*((RV32IMACFDPV*)cpu)->X[" + std::to_string(rs1 % 32U) + "U]);\n";
partInit.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
partInit.code() += "cpu->instructionPointer = cpu->nextPc;\n";
// -----------------------------------------------------------------------------
