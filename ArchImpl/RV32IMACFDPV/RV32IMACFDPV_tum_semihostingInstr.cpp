/**
 * Generated on Tue, 17 Jan 2023 12:10:13 +0100.
 *
...
partInit.code() += "etiss_uint32 operation = *((RV32IMACFDPV*)cpu)->X[10U];\n";
partInit.code() += "etiss_uint32 parameter = *((RV32IMACFDPV*)cpu)->X[11U];\n";
partInit.code() += "*((RV32IMACFDPV*)cpu)->X[10U] = (etiss_int32)(etiss_semihost(cpu, system, plugin_pointers, 32U, operation, parameter));\n";
partInit.code() += "}\n";
partInit.code() += "else {\n";
