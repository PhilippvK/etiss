...
partInit.code() += "((RV32IMACFDPV*)cpu)->RES_ADDR = offs;\n";
if (rd) {
...
partInit.code() += "cpu->nextPc = " + std::to_string(ic.current_address_ + 4U) + "U;\n";
partInit.code() += "etiss_uint32 offs = *((RV32IMACFDPV*)cpu)->X[" + std::to_string(rs1 % 32U) + "U];\n";
partInit.code() += "if (((RV32IMACFDPV*)cpu)->RES_ADDR == offs) {\n";
partInit.code() += "etiss_uint32 mem_val_0;\n";
...
partInit.code() += "}\n";
if (rd) {
partInit.code() += "*((RV32IMACFDPV*)cpu)->X[" + std::to_string(rd % 32U) + "U] = ((RV32IMACFDPV*)cpu)->RES_ADDR != offs;\n";
}
