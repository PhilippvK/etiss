...
partInit.code() += "etiss_uint32 offs = *((RV32IMACFDPV*)cpu)->X[" + std::to_string(rs1 % 32U) + "U];\n";
if ((rd % 32U) != 0U) {
...
partInit.code() += "}\n";
partInit.code() += "*((RV32IMACFDPV*)cpu)->X[" + std::to_string(rd % 32U) + "U] = (etiss_int32)(((etiss_int32)(mem_val_0)));\n";
}
partInit.code() += "etiss_uint32 mem_val_1;\n";
partInit.code() += "mem_val_1 = (etiss_int32)(*((RV32IMACFDPV*)cpu)->X[" + std::to_string(rs2 % 32U) + "U]);\n";
...
if ((rd % 32U) != 0U) {
partInit.code() += "*((RV32IMACFDPV*)cpu)->X[" + std::to_string(rd % 32U) + "U] = res1;\n";
}
partInit.code() += "etiss_uint32 res2 = res1 + *((RV32IMACFDPV*)cpu)->X[" + std::to_string(rs2 % 32U) + "U];\n";
partInit.code() += "etiss_uint32 mem_val_1;\n";
...
partInit.code() += "etiss_uint32 res2 = (res1 > (etiss_int32)(*((RV32IMACFDPV*)cpu)->X[" + std::to_string(rs2 % 32U) + "U])) ? (*((RV32IMACFDPV*)cpu)->X[" + std::to_string(rs2 % 32U) + "U]) : (res1);\n";
partInit.code() += "etiss_uint32 mem_val_1;\n";
partInit.code() += "mem_val_1 = res2;\n";
partInit.code() += "cpu->exception |= (*(system->dwrite))(system->handle, cpu, offs, (etiss_uint8*)&mem_val_1, 4);\n";
partInit.code() += "if (cpu->exception) {\n";
...
if ((rd % 32U) != 0U) {
partInit.code() += "*((RV32IMACFDPV*)cpu)->X[" + std::to_string(rd % 32U) + "U] = (etiss_int32)(res1);\n";
}
partInit.code() += "etiss_uint32 res2 = (res1 > *((RV32IMACFDPV*)cpu)->X[" + std::to_string(rs2 % 32U) + "U]) ? (*((RV32IMACFDPV*)cpu)->X[" + std::to_string(rs2 % 32U) + "U]) : (res1);\n";
partInit.code() += "etiss_uint32 mem_val_1;\n";
partInit.code() += "mem_val_1 = res2;\n";
partInit.code() += "cpu->exception |= (*(system->dwrite))(system->handle, cpu, offs, (etiss_uint8*)&mem_val_1, 4);\n";
partInit.code() += "if (cpu->exception) {\n";
