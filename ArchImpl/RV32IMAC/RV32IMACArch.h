...
#ifndef ETISS_RV32IMACArch_RV32IMACArch_H_
#define ETISS_RV32IMACArch_RV32IMACArch_H_

#include "etiss/CPUArch.h"
#include "etiss/Instruction.h"
#include "etiss/InterruptVector.h"
#include "RV32IMAC.h"
#include "RV32IMACGDBCore.h"

#include <map>

extern const char * const reg_name[];

extern etiss::instr::InstructionGroup ISA16_RV32IMAC;
extern etiss::instr::InstructionClass ISA16_RV32IMACClass;
extern etiss::instr::InstructionGroup ISA32_RV32IMAC;
extern etiss::instr::InstructionClass ISA32_RV32IMACClass;

extern etiss::instr::InstructionCollection RV32IMACISA;

class RV32IMACArch : public etiss::CPUArch {
...
public:
	...
	*/
	...
	/**
		@brief get the GDBcore for RV32IMAC architecture

		@see RV32IMACGDBCore.h for implementation of GDBcore
	*/
