...
if (imm) {
partInit.code() += "*((RV32IMAC*)cpu)->X[" + std::to_string(rd + 8U) + "] = *((RV32IMAC*)cpu)->X[2U] + " + std::to_string(imm) + ";\n";
} else {
partInit.code() += "((RV32IMAC*)cpu)->exception = raise(cpu, system, plugin_pointers, 0U, 2U);\n";
}
...
// -----------------------------------------------------------------------------
partInit.code() += "cpu->instructionPointer = " + std::to_string(ic.current_address_ + 2U) + ";\n";
partInit.code() += "etiss_uint32 load_address = *((RV32IMAC*)cpu)->X[" + std::to_string(rs1 + 8U) + "] + " + std::to_string(uimm) + ";\n";
...
partInit.code() += "*((RV32IMAC*)cpu)->X[" + std::to_string(rd + 8U) + "] = (etiss_int32)(mem_val_0);\n";
partInit.code() += "if (((RV32IMAC*)cpu)->exception) return ((RV32IMAC*)cpu)->exception;\n";
// -----------------------------------------------------------------------------
...
partInit.code() += "cpu->instructionPointer = " + std::to_string(ic.current_address_ + 2U) + ";\n";
partInit.code() += "etiss_uint32 load_address = *((RV32IMAC*)cpu)->X[" + std::to_string(rs1 + 8U) + "] + " + std::to_string(uimm) + ";\n";
partInit.code() += "etiss_uint32 mem_val_0 = (etiss_int32)(*((RV32IMAC*)cpu)->X[" + std::to_string(rs2 + 8U) + "]);\n";
partInit.code() += "((RV32IMAC*)cpu)->exception |= (*(system->dwrite))(system->handle, cpu, load_address, (etiss_uint8*)&mem_val_0, 4);\n";
...
partInit.code() += "cpu->instructionPointer = " + std::to_string(ic.current_address_ + 2U) + ";\n";
if ((rs1 % 32U) != 0U) {
partInit.code() += "*((RV32IMAC*)cpu)->X[" + std::to_string(rs1 % 32) + "] = *((RV32IMAC*)cpu)->X[" + std::to_string(rs1 % 32U) + "] + " + std::to_string(((etiss_int8)((imm) << (2)) >> (2))) + ";\n";
}
// -----------------------------------------------------------------------------
...
// -----------------------------------------------------------------------------
partInit.code() += "cpu->instructionPointer = " + std::to_string(ic.current_address_ + 2U) + ";\n";
partInit.code() += "*((RV32IMAC*)cpu)->X[1U] = " + std::to_string(ic.current_address_ + 2U) + ";\n";
...
partInit.code() += "cpu->instructionPointer = " + std::to_string(ic.current_address_ + 2U) + ";\n";
if ((rd % 32U) != 0U) {
partInit.code() += "*((RV32IMAC*)cpu)->X[" + std::to_string(rd % 32) + "] = " + std::to_string(((etiss_int8)((imm) << (2)) >> (2))) + ";\n";
}
// -----------------------------------------------------------------------------
...
if ((rd % 32U) != 0U) {
partInit.code() += "*((RV32IMAC*)cpu)->X[" + std::to_string(rd % 32) + "] = " + std::to_string(((etiss_int32)((imm) << (14)) >> (14))) + ";\n";
}
partInit.code() += "if (((RV32IMAC*)cpu)->exception) return ((RV32IMAC*)cpu)->exception;\n";
// -----------------------------------------------------------------------------
...
partInit.code() += "cpu->instructionPointer = " + std::to_string(ic.current_address_ + 2U) + ";\n";
if (nzimm) {
partInit.code() += "*((RV32IMAC*)cpu)->X[2U] = *((RV32IMAC*)cpu)->X[2U] + " + std::to_string(((etiss_int16)((nzimm) << (6)) >> (6))) + ";\n";
} else {
partInit.code() += "((RV32IMAC*)cpu)->exception = raise(cpu, system, plugin_pointers, 0U, 2U);\n";
}
partInit.code() += "if (((RV32IMAC*)cpu)->exception) return ((RV32IMAC*)cpu)->exception;\n";
...
// -----------------------------------------------------------------------------
partInit.code() += "cpu->instructionPointer = " + std::to_string(ic.current_address_ + 2U) + ";\n";
partInit.code() += "*((RV32IMAC*)cpu)->X[" + std::to_string(rs1 + 8U) + "] = *((RV32IMAC*)cpu)->X[" + std::to_string(rs1 + 8U) + "] >> " + std::to_string(shamt) + ";\n";
// -----------------------------------------------------------------------------
...
partInit.code() += "cpu->instructionPointer = " + std::to_string(ic.current_address_ + 2U) + ";\n";
if (shamt) {
partInit.code() += "*((RV32IMAC*)cpu)->X[" + std::to_string(rs1 + 8U) + "] = ((etiss_int32)(*((RV32IMAC*)cpu)->X[" + std::to_string(rs1 + 8U) + "])) >> " + std::to_string(shamt) + ";\n";
}
// -----------------------------------------------------------------------------
...
// -----------------------------------------------------------------------------
partInit.code() += "cpu->instructionPointer = " + std::to_string(ic.current_address_ + 2U) + ";\n";
partInit.code() += "*((RV32IMAC*)cpu)->X[" + std::to_string(rs1 + 8U) + "] = *((RV32IMAC*)cpu)->X[" + std::to_string(rs1 + 8U) + "] & " + std::to_string(((etiss_int8)((imm) << (2)) >> (2))) + ";\n";
// -----------------------------------------------------------------------------
...
// -----------------------------------------------------------------------------
partInit.code() += "cpu->instructionPointer = " + std::to_string(ic.current_address_ + 2U) + ";\n";
partInit.code() += "*((RV32IMAC*)cpu)->X[" + std::to_string(rd + 8U) + "] = *((RV32IMAC*)cpu)->X[" + std::to_string(rd + 8U) + "] - *((RV32IMAC*)cpu)->X[" + std::to_string(rs2 + 8U) + "];\n";
// -----------------------------------------------------------------------------
...
// -----------------------------------------------------------------------------
partInit.code() += "cpu->instructionPointer = " + std::to_string(ic.current_address_ + 2U) + ";\n";
partInit.code() += "if (*((RV32IMAC*)cpu)->X[" + std::to_string(rs1 + 8U) + "] == 0U) {\n";
partInit.code() += "cpu->instructionPointer = " + std::to_string(ic.current_address_ + ((etiss_int16)((imm) << (7)) >> (7))) + ";\n";
partInit.code() += "}\n";
partInit.code() += "if (cpu->instructionPointer != " + std::to_string(ic.current_address_ + 2) + ") return ((RV32IMAC*)cpu)->exception;\n";
// -----------------------------------------------------------------------------
...
partInit.code() += "cpu->instructionPointer = " + std::to_string(ic.current_address_ + 2U) + ";\n";
if (nzuimm) {
partInit.code() += "*((RV32IMAC*)cpu)->X[" + std::to_string(rs1 % 32) + "] = *((RV32IMAC*)cpu)->X[" + std::to_string(rs1 % 32U) + "] << " + std::to_string(nzuimm) + ";\n";
}
// -----------------------------------------------------------------------------
...
if (rd % 32U) {
partInit.code() += "etiss_uint32 mem_val_0;\n";
partInit.code() += "((RV32IMAC*)cpu)->exception |= (*(system->dread))(system->handle, cpu, *((RV32IMAC*)cpu)->X[2U] + " + std::to_string(uimm) + ", (etiss_uint8*)&mem_val_0, 4);\n";
partInit.code() += "etiss_int32 res = mem_val_0;\n";
partInit.code() += "*((RV32IMAC*)cpu)->X[" + std::to_string(rd % 32) + "] = (etiss_int32)(res);\n";
} else {
partInit.code() += "((RV32IMAC*)cpu)->exception = raise(cpu, system, plugin_pointers, 0U, 2U);\n";
}
partInit.code() += "if (((RV32IMAC*)cpu)->exception) return ((RV32IMAC*)cpu)->exception;\n";
...
partInit.code() += "cpu->instructionPointer = " + std::to_string(ic.current_address_ + 2U) + ";\n";
if ((rd % 32U) != 0U) {
partInit.code() += "*((RV32IMAC*)cpu)->X[" + std::to_string(rd % 32) + "] = *((RV32IMAC*)cpu)->X[" + std::to_string(rs2 % 32U) + "];\n";
}
// -----------------------------------------------------------------------------
...
partInit.code() += "cpu->instructionPointer = " + std::to_string(ic.current_address_ + 2U) + ";\n";
if (rs1) {
partInit.code() += "cpu->instructionPointer = *((RV32IMAC*)cpu)->X[" + std::to_string(rs1 % 32U) + "] & -2;\n";
} else {
partInit.code() += "((RV32IMAC*)cpu)->exception = raise(cpu, system, plugin_pointers, 0U, 2U);\n";
}
partInit.code() += "return ((RV32IMAC*)cpu)->exception;\n";
...
partInit.code() += "cpu->instructionPointer = " + std::to_string(ic.current_address_ + 2U) + ";\n";
if ((rd % 32U) != 0U) {
partInit.code() += "*((RV32IMAC*)cpu)->X[" + std::to_string(rd % 32) + "] = *((RV32IMAC*)cpu)->X[" + std::to_string(rd % 32U) + "] + *((RV32IMAC*)cpu)->X[" + std::to_string(rs2 % 32U) + "];\n";
}
// -----------------------------------------------------------------------------
...
// -----------------------------------------------------------------------------
partInit.code() += "cpu->instructionPointer = " + std::to_string(ic.current_address_ + 2U) + ";\n";
partInit.code() += "etiss_uint32 new_pc = *((RV32IMAC*)cpu)->X[" + std::to_string(rs1 % 32U) + "];\n";
partInit.code() += "*((RV32IMAC*)cpu)->X[1U] = " + std::to_string(ic.current_address_ + 2U) + ";\n";
...
// -----------------------------------------------------------------------------
partInit.code() += "cpu->instructionPointer = " + std::to_string(ic.current_address_ + 2U) + ";\n";
partInit.code() += "etiss_uint32 offs = *((RV32IMAC*)cpu)->X[2U] + " + std::to_string(uimm) + ";\n";
partInit.code() += "etiss_uint32 mem_val_0 = (etiss_uint32)(*((RV32IMAC*)cpu)->X[" + std::to_string(rs2 % 32U) + "]);\n";
partInit.code() += "((RV32IMAC*)cpu)->exception |= (*(system->dwrite))(system->handle, cpu, offs, (etiss_uint8*)&mem_val_0, 4);\n";
