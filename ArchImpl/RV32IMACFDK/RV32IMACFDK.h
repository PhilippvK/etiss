 ...
 *
 * This file contains the registers for the RV32IMACFDK core architecture.
 */

#ifndef ETISS_RV32IMACFDKArch_RV32IMACFDK_H_
#define ETISS_RV32IMACFDKArch_RV32IMACFDK_H_
#include <stdio.h>
...
typedef struct RV32IMACFDK RV32IMACFDK; // convenient use of X instead of struct X in generated C code
#ifdef __cplusplus
} // extern "C"
#endif
#endif
