...
rm = ((((((RV32IMACFDV*)cpu)->FCSR) >> (5ULL)) & 7ULL)) & 0x7;
} // conditional
...
return (((1ULL) << 30) | ((((*((RV32IMACFDV*)cpu)->CSR[769LL]) >> (0LL)) & 1073741823ULL)));
} // conditional
