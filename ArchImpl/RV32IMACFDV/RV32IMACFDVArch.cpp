...
* Modification guidelines:
     ...
     7. Implementation dependent functionalities such as exception handling should be manully added. Corresponding
         interfaces are provided in RV32IMACFDVArchSpecificImp.h
...
void RV32IMACFDVArch::resetCPU(ETISS_CPU *cpu, etiss::uint64 *startpointer)
{
    ...
    rv32imacfdvcpu->MCYCLE = 0;
    rv32imacfdvcpu->MCYCLEH = 0;
    ...
    rv32imacfdvcpu->CSR[2816] = &rv32imacfdvcpu->MCYCLE;
    rv32imacfdvcpu->CSR[2944] = &rv32imacfdvcpu->MCYCLEH;
