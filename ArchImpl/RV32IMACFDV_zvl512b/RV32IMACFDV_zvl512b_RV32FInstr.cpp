...
{ // block
cp.code() += "{ // block\n";
cp.code() += "*((RV32IMACFDV_zvl512b*)cpu)->F[" + std::to_string(rd) + "ULL] = fmadd_s(*((RV32IMACFDV_zvl512b*)cpu)->F[" + std::to_string(rs1) + "ULL], *((RV32IMACFDV_zvl512b*)cpu)->F[" + std::to_string(rs2) + "ULL], *((RV32IMACFDV_zvl512b*)cpu)->F[" + std::to_string(rs3) + "ULL], 0LL, RV32IMACFDV_zvl512b_get_rm(cpu, system, plugin_pointers, " + std::to_string(rm) + "ULL));\n";
...
{ // block
cp.code() += "{ // block\n";
cp.code() += "*((RV32IMACFDV_zvl512b*)cpu)->F[" + std::to_string(rd) + "ULL] = fmadd_s(*((RV32IMACFDV_zvl512b*)cpu)->F[" + std::to_string(rs1) + "ULL], *((RV32IMACFDV_zvl512b*)cpu)->F[" + std::to_string(rs2) + "ULL], *((RV32IMACFDV_zvl512b*)cpu)->F[" + std::to_string(rs3) + "ULL], 1ULL, RV32IMACFDV_zvl512b_get_rm(cpu, system, plugin_pointers, " + std::to_string(rm) + "ULL));\n";
cp.code() += "etiss_uint32 flags = fget_flags();\n";
cp.code() += "((RV32IMACFDV_zvl512b*)cpu)->FCSR = (((RV32IMACFDV_zvl512b*)cpu)->FCSR & -32LL) | (flags & 31ULL);\n";
cp.code() += "} // block\n";
} // block
...
{ // block
cp.code() += "{ // block\n";
cp.code() += "*((RV32IMACFDV_zvl512b*)cpu)->F[" + std::to_string(rd) + "ULL] = fmadd_s(*((RV32IMACFDV_zvl512b*)cpu)->F[" + std::to_string(rs1) + "ULL], *((RV32IMACFDV_zvl512b*)cpu)->F[" + std::to_string(rs2) + "ULL], *((RV32IMACFDV_zvl512b*)cpu)->F[" + std::to_string(rs3) + "ULL], 2ULL, RV32IMACFDV_zvl512b_get_rm(cpu, system, plugin_pointers, " + std::to_string(rm) + "ULL));\n";
cp.code() += "etiss_uint32 flags = fget_flags();\n";
cp.code() += "((RV32IMACFDV_zvl512b*)cpu)->FCSR = (((RV32IMACFDV_zvl512b*)cpu)->FCSR & -32LL) | (flags & 31ULL);\n";
cp.code() += "} // block\n";
} // block
...
{ // block
cp.code() += "{ // block\n";
cp.code() += "*((RV32IMACFDV_zvl512b*)cpu)->F[" + std::to_string(rd) + "ULL] = fmadd_s(*((RV32IMACFDV_zvl512b*)cpu)->F[" + std::to_string(rs1) + "ULL], *((RV32IMACFDV_zvl512b*)cpu)->F[" + std::to_string(rs2) + "ULL], *((RV32IMACFDV_zvl512b*)cpu)->F[" + std::to_string(rs3) + "ULL], 3ULL, RV32IMACFDV_zvl512b_get_rm(cpu, system, plugin_pointers, " + std::to_string(rm) + "ULL));\n";
cp.code() += "etiss_uint32 flags = fget_flags();\n";
cp.code() += "((RV32IMACFDV_zvl512b*)cpu)->FCSR = (((RV32IMACFDV_zvl512b*)cpu)->FCSR & -32LL) | (flags & 31ULL);\n";
cp.code() += "} // block\n";
} // block
...
{ // block
cp.code() += "{ // block\n";
cp.code() += "*((RV32IMACFDV_zvl512b*)cpu)->F[" + std::to_string(rd) + "ULL] = fadd_s(*((RV32IMACFDV_zvl512b*)cpu)->F[" + std::to_string(rs1) + "ULL], *((RV32IMACFDV_zvl512b*)cpu)->F[" + std::to_string(rs2) + "ULL], RV32IMACFDV_zvl512b_get_rm(cpu, system, plugin_pointers, " + std::to_string(rm) + "ULL));\n";
cp.code() += "etiss_uint32 flags = fget_flags();\n";
cp.code() += "((RV32IMACFDV_zvl512b*)cpu)->FCSR = (((RV32IMACFDV_zvl512b*)cpu)->FCSR & -32LL) | (flags & 31ULL);\n";
cp.code() += "} // block\n";
} // block
...
{ // block
cp.code() += "{ // block\n";
cp.code() += "*((RV32IMACFDV_zvl512b*)cpu)->F[" + std::to_string(rd) + "ULL] = fsub_s(*((RV32IMACFDV_zvl512b*)cpu)->F[" + std::to_string(rs1) + "ULL], *((RV32IMACFDV_zvl512b*)cpu)->F[" + std::to_string(rs2) + "ULL], RV32IMACFDV_zvl512b_get_rm(cpu, system, plugin_pointers, " + std::to_string(rm) + "ULL));\n";
cp.code() += "etiss_uint32 flags = fget_flags();\n";
cp.code() += "((RV32IMACFDV_zvl512b*)cpu)->FCSR = (((RV32IMACFDV_zvl512b*)cpu)->FCSR & -32LL) | (flags & 31ULL);\n";
cp.code() += "} // block\n";
} // block
...
{ // block
cp.code() += "{ // block\n";
cp.code() += "*((RV32IMACFDV_zvl512b*)cpu)->F[" + std::to_string(rd) + "ULL] = fmul_s(*((RV32IMACFDV_zvl512b*)cpu)->F[" + std::to_string(rs1) + "ULL], *((RV32IMACFDV_zvl512b*)cpu)->F[" + std::to_string(rs2) + "ULL], RV32IMACFDV_zvl512b_get_rm(cpu, system, plugin_pointers, " + std::to_string(rm) + "ULL));\n";
cp.code() += "etiss_uint32 flags = fget_flags();\n";
cp.code() += "((RV32IMACFDV_zvl512b*)cpu)->FCSR = (((RV32IMACFDV_zvl512b*)cpu)->FCSR & -32LL) | (flags & 31ULL);\n";
cp.code() += "} // block\n";
} // block
...
{ // block
cp.code() += "{ // block\n";
cp.code() += "*((RV32IMACFDV_zvl512b*)cpu)->F[" + std::to_string(rd) + "ULL] = fdiv_s(*((RV32IMACFDV_zvl512b*)cpu)->F[" + std::to_string(rs1) + "ULL], *((RV32IMACFDV_zvl512b*)cpu)->F[" + std::to_string(rs2) + "ULL], RV32IMACFDV_zvl512b_get_rm(cpu, system, plugin_pointers, " + std::to_string(rm) + "ULL));\n";
cp.code() += "etiss_uint32 flags = fget_flags();\n";
cp.code() += "((RV32IMACFDV_zvl512b*)cpu)->FCSR = (((RV32IMACFDV_zvl512b*)cpu)->FCSR & -32LL) | (flags & 31ULL);\n";
cp.code() += "} // block\n";
} // block
...
{ // block
cp.code() += "{ // block\n";
cp.code() += "*((RV32IMACFDV_zvl512b*)cpu)->F[" + std::to_string(rd) + "ULL] = fsqrt_s(*((RV32IMACFDV_zvl512b*)cpu)->F[" + std::to_string(rs1) + "ULL], RV32IMACFDV_zvl512b_get_rm(cpu, system, plugin_pointers, " + std::to_string(rm) + "ULL));\n";
cp.code() += "etiss_uint32 flags = fget_flags();\n";
cp.code() += "((RV32IMACFDV_zvl512b*)cpu)->FCSR = (((RV32IMACFDV_zvl512b*)cpu)->FCSR & -32LL) | (flags & 31ULL);\n";
cp.code() += "} // block\n";
} // block
...
{ // block
cp.code() += "{ // block\n";
cp.code() += "*((RV32IMACFDV_zvl512b*)cpu)->F[" + std::to_string(rd) + "ULL] = ((((((*((RV32IMACFDV_zvl512b*)cpu)->F[" + std::to_string(rs2) + "ULL]) >> (31ULL)) & 1ULL)) << 31) | ((((*((RV32IMACFDV_zvl512b*)cpu)->F[" + std::to_string(rs1) + "ULL]) >> (0LL)) & 2147483647ULL)));\n";
cp.code() += "} // block\n";
} // block
cp.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
cp.code() += "cpu->instructionPointer = cpu->nextPc;\n";
...
{ // block
cp.code() += "{ // block\n";
cp.code() += "*((RV32IMACFDV_zvl512b*)cpu)->F[" + std::to_string(rd) + "ULL] = *((RV32IMACFDV_zvl512b*)cpu)->F[" + std::to_string(rs1) + "ULL] ^ (*((RV32IMACFDV_zvl512b*)cpu)->F[" + std::to_string(rs2) + "ULL] & 2147483648ULL);\n";
cp.code() += "} // block\n";
} // block
cp.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
cp.code() += "cpu->instructionPointer = cpu->nextPc;\n";
...
{ // block
cp.code() += "{ // block\n";
cp.code() += "*((RV32IMACFDV_zvl512b*)cpu)->F[" + std::to_string(rd) + "ULL] = fsel_s(*((RV32IMACFDV_zvl512b*)cpu)->F[" + std::to_string(rs1) + "ULL], *((RV32IMACFDV_zvl512b*)cpu)->F[" + std::to_string(rs2) + "ULL], 0LL);\n";
cp.code() += "etiss_uint32 flags = fget_flags();\n";
cp.code() += "((RV32IMACFDV_zvl512b*)cpu)->FCSR = (((RV32IMACFDV_zvl512b*)cpu)->FCSR & -32LL) | (flags & 31ULL);\n";
cp.code() += "} // block\n";
} // block
...
{ // block
cp.code() += "{ // block\n";
cp.code() += "*((RV32IMACFDV_zvl512b*)cpu)->F[" + std::to_string(rd) + "ULL] = fsel_s(*((RV32IMACFDV_zvl512b*)cpu)->F[" + std::to_string(rs1) + "ULL], *((RV32IMACFDV_zvl512b*)cpu)->F[" + std::to_string(rs2) + "ULL], 1ULL);\n";
cp.code() += "etiss_uint32 flags = fget_flags();\n";
cp.code() += "((RV32IMACFDV_zvl512b*)cpu)->FCSR = (((RV32IMACFDV_zvl512b*)cpu)->FCSR & -32LL) | (flags & 31ULL);\n";
cp.code() += "} // block\n";
} // block
...
cp.code() += "res = fcvt_s(*((RV32IMACFDV_zvl512b*)cpu)->F[" + std::to_string(rs1) + "ULL], 0LL, " + std::to_string(rm) + "ULL);\n";
...
cp.code() += "res = fcvt_s(*((RV32IMACFDV_zvl512b*)cpu)->F[" + std::to_string(rs1) + "ULL], 1ULL, " + std::to_string(rm) + "ULL);\n";
if ((rd % 32ULL) != 0LL) { // conditional
cp.code() += "*((RV32IMACFDV_zvl512b*)cpu)->X[" + std::to_string(rd % 32ULL) + "ULL] = (etiss_uint32)((etiss_int32)(res));\n";
} // conditional
cp.code() += "etiss_uint32 flags = fget_flags();\n";
cp.code() += "((RV32IMACFDV_zvl512b*)cpu)->FCSR = (((RV32IMACFDV_zvl512b*)cpu)->FCSR & -32LL) | (flags & 31ULL);\n";
cp.code() += "} // block\n";
...
cp.code() += "{ // block\n";
cp.code() += "etiss_uint32 res = 0LL;\n";
cp.code() += "res = fcmp_s(*((RV32IMACFDV_zvl512b*)cpu)->F[" + std::to_string(rs1) + "ULL], *((RV32IMACFDV_zvl512b*)cpu)->F[" + std::to_string(rs2) + "ULL], 0LL);\n";
if ((rd % 32ULL) != 0LL) { // conditional
cp.code() += "*((RV32IMACFDV_zvl512b*)cpu)->X[" + std::to_string(rd % 32ULL) + "ULL] = res;\n";
} // conditional
cp.code() += "etiss_uint32 flags = fget_flags();\n";
...
cp.code() += "{ // block\n";
cp.code() += "etiss_uint32 res = 0LL;\n";
cp.code() += "res = fcmp_s(*((RV32IMACFDV_zvl512b*)cpu)->F[" + std::to_string(rs1) + "ULL], *((RV32IMACFDV_zvl512b*)cpu)->F[" + std::to_string(rs2) + "ULL], 2ULL);\n";
if ((rd % 32ULL) != 0LL) { // conditional
cp.code() += "*((RV32IMACFDV_zvl512b*)cpu)->X[" + std::to_string(rd % 32ULL) + "ULL] = res;\n";
} // conditional
cp.code() += "etiss_uint32 flags = fget_flags();\n";
...
cp.code() += "{ // block\n";
cp.code() += "etiss_uint32 res = 0LL;\n";
cp.code() += "res = fcmp_s(*((RV32IMACFDV_zvl512b*)cpu)->F[" + std::to_string(rs1) + "ULL], *((RV32IMACFDV_zvl512b*)cpu)->F[" + std::to_string(rs2) + "ULL], 1ULL);\n";
if ((rd % 32ULL) != 0LL) { // conditional
cp.code() += "*((RV32IMACFDV_zvl512b*)cpu)->X[" + std::to_string(rd % 32ULL) + "ULL] = res;\n";
} // conditional
cp.code() += "etiss_uint32 flags = fget_flags();\n";
...
cp.code() += "{ // block\n";
cp.code() += "etiss_uint32 res = 0LL;\n";
cp.code() += "res = fclass_s(*((RV32IMACFDV_zvl512b*)cpu)->F[" + std::to_string(rs1) + "ULL]);\n";
if ((rd % 32ULL) != 0LL) { // conditional
cp.code() += "*((RV32IMACFDV_zvl512b*)cpu)->X[" + std::to_string(rd % 32ULL) + "ULL] = res;\n";
} // conditional
cp.code() += "} // block\n";
...
{ // block
cp.code() += "{ // block\n";
cp.code() += "*((RV32IMACFDV_zvl512b*)cpu)->F[" + std::to_string(rd) + "ULL] = fcvt_s((etiss_uint32)(*((RV32IMACFDV_zvl512b*)cpu)->X[" + std::to_string(rs1 % 32ULL) + "ULL]), 2ULL, " + std::to_string(rm) + "ULL);\n";
cp.code() += "} // block\n";
} // block
cp.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
cp.code() += "cpu->instructionPointer = cpu->nextPc;\n";
...
{ // block
cp.code() += "{ // block\n";
cp.code() += "*((RV32IMACFDV_zvl512b*)cpu)->F[" + std::to_string(rd) + "ULL] = fcvt_s((etiss_uint32)(*((RV32IMACFDV_zvl512b*)cpu)->X[" + std::to_string(rs1 % 32ULL) + "ULL]), 3ULL, " + std::to_string(rm) + "ULL);\n";
cp.code() += "} // block\n";
} // block
cp.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
cp.code() += "cpu->instructionPointer = cpu->nextPc;\n";
...
cp.code() += "{ // block\n";
if ((rd % 32ULL) != 0LL) { // conditional
cp.code() += "*((RV32IMACFDV_zvl512b*)cpu)->X[" + std::to_string(rd % 32ULL) + "ULL] = (etiss_uint32)((etiss_int32)(*((RV32IMACFDV_zvl512b*)cpu)->F[" + std::to_string(rs1) + "ULL]));\n";
} // conditional
cp.code() += "} // block\n";
} // block
cp.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
...
{ // block
cp.code() += "{ // block\n";
cp.code() += "*((RV32IMACFDV_zvl512b*)cpu)->F[" + std::to_string(rd) + "ULL] = *((RV32IMACFDV_zvl512b*)cpu)->X[" + std::to_string(rs1 % 32ULL) + "ULL];\n";
cp.code() += "} // block\n";
} // block
cp.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
cp.code() += "cpu->instructionPointer = cpu->nextPc;\n";
