 ...
 *
 * This file contains the GDBCore adapter for the RV32IMACFDV_zvl512b core architecture.
 *
 * WARNING: This file contains user-added code, be mindful when overwriting this with
 * generated code!
 */

#ifndef ETISS_RV32IMACFDV_zvl512bArch_RV32IMACFDV_zvl512bGDBCORE_H_
#define ETISS_RV32IMACFDV_zvl512bArch_RV32IMACFDV_zvl512bGDBCORE_H_

#include "etiss/IntegratedLibrary/gdb/GDBCore.h"
#include <sstream>

/**
	@brief This class is the brige between RV32IMACFDV_zvl512b architecture and gdbserver

	@details Gdbserver integrated in ETISS calls GDBCore to read/write registers via virtualStrruct
				The index in mapRegister() should strictly follow the RV32IMACFDV_zvl512b gdb tool defined register
				...
				virtualStruct in RV32IMACFDV_zvl512bArch.cpp should be modified as well as well

*/
class RV32IMACFDV_zvl512bGDBCore : public etiss::plugin::gdb::GDBCore {
public:
	...
	bool isLittleEndian(){
		// Modify according to RV32IMACFDV_zvl512b manual
		return true;
	}
};
