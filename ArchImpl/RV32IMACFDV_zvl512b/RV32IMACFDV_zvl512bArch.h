...
#ifndef ETISS_RV32IMACFDV_zvl512bArch_RV32IMACFDV_zvl512bArch_H_
#define ETISS_RV32IMACFDV_zvl512bArch_RV32IMACFDV_zvl512bArch_H_
...
#include "RV32IMACFDV_zvl512bGDBCore.h"

#include <map>

extern const char * const reg_name[];

extern etiss::instr::InstructionGroup ISA16_RV32IMACFDV_zvl512b;
extern etiss::instr::InstructionClass ISA16_RV32IMACFDV_zvl512bClass;
extern etiss::instr::InstructionGroup ISA32_RV32IMACFDV_zvl512b;
extern etiss::instr::InstructionClass ISA32_RV32IMACFDV_zvl512bClass;

extern etiss::instr::InstructionCollection RV32IMACFDV_zvl512bISA;

class RV32IMACFDV_zvl512bArch : public etiss::CPUArch {

public:
	RV32IMACFDV_zvl512bArch(unsigned int);
	...
	/**
		...
		@see RV32IMACFDV_zvl512bArchSpecificImp.h
	*/
	...
	*/
	...
	/**
		@brief get the GDBcore for RV32IMACFDV_zvl512b architecture

		@see RV32IMACFDV_zvl512bGDBCore.h for implementation of GDBcore
	*/
...
private:
	...
	RV32IMACFDV_zvl512bGDBCore gdbcore_;
