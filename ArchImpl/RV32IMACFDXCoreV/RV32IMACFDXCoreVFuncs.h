...
rm = ((((((RV32IMACFDXCoreV*)cpu)->FCSR) >> (5ULL)) & 7)) & 0x7;
} // conditional
...
if ((get_field(*((RV32IMACFDXCoreV*)cpu)->CSR[384LL], 2147483648ULL))) { // conditional
mask = mask | 262144LL;
} // conditional
} // block
} // conditional
...
return *((RV32IMACFDXCoreV*)cpu)->CSR[3LL] & 31ULL;
} // conditional
if (csr == 2LL) { // conditional
return (*((RV32IMACFDXCoreV*)cpu)->CSR[3LL] >> 5ULL) & 7ULL;
} // conditional
...
return *((RV32IMACFDXCoreV*)cpu)->CSR[768LL] | 8589934592ULL | 34359738368ULL;
} // conditional
if (csr == 769LL) { // conditional
return (((1ULL) << 30) | ((((*((RV32IMACFDXCoreV*)cpu)->CSR[769LL]) >> (0ULL)) & 1073741823)));
} // conditional
return *((RV32IMACFDXCoreV*)cpu)->CSR[csr];
} // block
}
...
{ // block
if (csr == 1LL) { // conditional
*((RV32IMACFDXCoreV*)cpu)->CSR[3LL] = (*((RV32IMACFDXCoreV*)cpu)->CSR[3LL] & 224ULL) | (val & 31ULL);
} // conditional
 else if (csr == 2LL) { // conditional
*((RV32IMACFDXCoreV*)cpu)->CSR[3LL] = ((val & 7ULL) << 5ULL) | (*((RV32IMACFDXCoreV*)cpu)->CSR[3LL] & 31ULL);
} // conditional
 else if (csr == 3LL) { // conditional
*((RV32IMACFDXCoreV*)cpu)->CSR[3LL] = val & 255ULL;
} // conditional
 else if (csr == 768LL) { // conditional
*((RV32IMACFDXCoreV*)cpu)->CSR[768LL] = val & mstatus_mask(cpu, system, plugin_pointers);
} // conditional
 else if (csr == 256LL) { // conditional
*((RV32IMACFDXCoreV*)cpu)->CSR[768LL] = val & sstatus_mask(cpu, system, plugin_pointers);
} // conditional
 else if (csr != 769LL) { // conditional
*((RV32IMACFDXCoreV*)cpu)->CSR[csr] = val;
} // conditional
} // block
}
...
if (irq2) { // conditional
{ // block
deleg = ((((RV32IMACFDXCoreV*)cpu)->PRIV <= 1LL)) ? (*((RV32IMACFDXCoreV*)cpu)->CSR[771LL]) : (0ULL);
bit = bit & 2147483647ULL;
} // block
} // conditional
else { // conditional
{ // block
deleg = ((((RV32IMACFDXCoreV*)cpu)->PRIV <= 1LL)) ? (*((RV32IMACFDXCoreV*)cpu)->CSR[770LL]) : (0ULL);
} // block
} // conditional
if (((RV32IMACFDXCoreV*)cpu)->PRIV <= 1LL && (deleg >> bit) & 1ULL) { // conditional
{ // block
vector = ((*((RV32IMACFDXCoreV*)cpu)->CSR[261LL] & 1ULL) && irq2) ? (bit * 4ULL) : (0ULL);
cpu->nextPc = (*((RV32IMACFDXCoreV*)cpu)->CSR[261LL] & -2LL) + vector;
...
{ // block
vector = ((*((RV32IMACFDXCoreV*)cpu)->CSR[773LL] & 1ULL) && irq2) ? (bit * 4ULL) : (0ULL);
cpu->nextPc = (*((RV32IMACFDXCoreV*)cpu)->CSR[773LL] & -2LL) + vector;
...
{
{ // block
etiss_uint32 pending_interrupts = *((RV32IMACFDXCoreV*)cpu)->CSR[772LL] & *((RV32IMACFDXCoreV*)cpu)->CSR[836LL];
if (!(pending_interrupts)) { // conditional
return 0ULL;
} // conditional
etiss_uint32 mie = get_field(*((RV32IMACFDXCoreV*)cpu)->CSR[768LL], 8LL);
etiss_uint32 m_enabled = ((RV32IMACFDXCoreV*)cpu)->PRIV < 3LL || (((RV32IMACFDXCoreV*)cpu)->PRIV == 3LL && mie);
etiss_uint32 enabled_interrupts = pending_interrupts & ~(*((RV32IMACFDXCoreV*)cpu)->CSR[771LL]) & -(m_enabled);
if (enabled_interrupts == 0ULL) { // conditional
{ // block
etiss_uint32 deleg = *((RV32IMACFDXCoreV*)cpu)->CSR[771LL];
etiss_uint32 sie = get_field(csr_read(cpu, system, plugin_pointers, 256LL), 2LL);
etiss_uint32 s_enabled = ((RV32IMACFDXCoreV*)cpu)->PRIV < 1LL || (((RV32IMACFDXCoreV*)cpu)->PRIV == 1LL && sie);
