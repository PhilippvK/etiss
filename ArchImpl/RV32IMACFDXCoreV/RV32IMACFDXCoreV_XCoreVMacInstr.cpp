...
{ // block
cp.code() += "{ // block\n";
cp.code() += "etiss_int128 result = ((etiss_int32)(*((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rs1) + "ULL]) * (etiss_int32)(*((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rs2) + "ULL]) + (etiss_int32)(*((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rd) + "ULL])) & 0x1ffffffffffffffff;\n";
if (rd != 0ULL) { // conditional
cp.code() += "*((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rd) + "ULL] = (etiss_uint32)(result);\n";
} // conditional
cp.code() += "} // block\n";
} // block
