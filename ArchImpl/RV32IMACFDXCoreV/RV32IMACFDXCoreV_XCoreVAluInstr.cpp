...
{ // block
cp.code() += "{ // block\n";
cp.code() += "*((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rd) + "ULL] = (((etiss_int32)(*((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rs1) + "ULL]) < 0ULL)) ? (((((-(*((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rs1) + "ULL]))) >> (0ULL)) & 4294967295)) : (*((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rs1) + "ULL]);\n";
cp.code() += "} // block\n";
} // block
} // conditional
cp.code() += "} // block\n";
...
{ // block
cp.code() += "{ // block\n";
cp.code() += "*((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rd) + "ULL] = (etiss_uint8)(((etiss_int32)(*((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rs1) + "ULL]) <= (etiss_int32)((((*((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rs2) + "ULL]) >> (0ULL)) & 4294967295))));\n";
cp.code() += "} // block\n";
} // block
} // conditional
cp.code() += "} // block\n";
...
{ // block
cp.code() += "{ // block\n";
cp.code() += "*((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rd) + "ULL] = (etiss_uint8)(((etiss_uint32)(*((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rs1) + "ULL]) <= (etiss_uint32)((((*((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rs2) + "ULL]) >> (0ULL)) & 4294967295))));\n";
cp.code() += "} // block\n";
} // block
} // conditional
cp.code() += "} // block\n";
...
{ // block
cp.code() += "{ // block\n";
cp.code() += "*((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rd) + "ULL] = (((etiss_int32)(*((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rs1) + "ULL]) < (etiss_int32)((((*((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rs2) + "ULL]) >> (0ULL)) & 4294967295)))) ? (*((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rs1) + "ULL]) : ((((*((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rs2) + "ULL]) >> (0ULL)) & 4294967295));\n";
cp.code() += "} // block\n";
} // block
} // conditional
cp.code() += "} // block\n";
...
{ // block
cp.code() += "{ // block\n";
cp.code() += "*((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rd) + "ULL] = (((etiss_uint32)(*((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rs1) + "ULL]) < (etiss_uint32)((((*((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rs2) + "ULL]) >> (0ULL)) & 4294967295)))) ? (*((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rs1) + "ULL]) : ((((*((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rs2) + "ULL]) >> (0ULL)) & 4294967295));\n";
cp.code() += "} // block\n";
} // block
} // conditional
cp.code() += "} // block\n";
...
{ // block
cp.code() += "{ // block\n";
cp.code() += "*((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rd) + "ULL] = (etiss_int16)((((*((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rs1) + "ULL]) >> (0ULL)) & 65535));\n";
cp.code() += "} // block\n";
} // block
} // conditional
cp.code() += "} // block\n";
...
{ // block
cp.code() += "{ // block\n";
cp.code() += "*((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rd) + "ULL] = (etiss_uint16)((((*((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rs1) + "ULL]) >> (0ULL)) & 65535));\n";
cp.code() += "} // block\n";
} // block
} // conditional
cp.code() += "} // block\n";
...
{ // block
cp.code() += "{ // block\n";
cp.code() += "*((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rd) + "ULL] = (etiss_int8)((((*((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rs1) + "ULL]) >> (0ULL)) & 255));\n";
cp.code() += "} // block\n";
} // block
} // conditional
cp.code() += "} // block\n";
...
{ // block
cp.code() += "{ // block\n";
cp.code() += "*((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rd) + "ULL] = (etiss_uint8)((((*((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rs1) + "ULL]) >> (0ULL)) & 255));\n";
cp.code() += "} // block\n";
} // block
} // conditional
cp.code() += "} // block\n";
...
cp.code() += "if (*((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rs1) + "ULL] <= " + std::to_string(a) + "LL) { // conditional\n";
cp.code() += "*((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rd) + "ULL] = " + std::to_string(a) + "LL;\n";
cp.code() += "} // conditional\n";
cp.code() += " else if (*((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rs1) + "ULL] >= " + std::to_string(b) + "LL) { // conditional\n";
cp.code() += "*((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rd) + "ULL] = " + std::to_string(b) + "LL;\n";
cp.code() += "} // conditional\n";
cp.code() += "else { // conditional\n";
cp.code() += "*((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rd) + "ULL] = *((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rs1) + "ULL];\n";
cp.code() += "} // conditional\n";
cp.code() += "} // block\n";
} // block
} // conditional
...
etiss_int32 a = 0ULL;
etiss_int32 b = ((Iuimm5)) ? (((1ULL << (Iuimm5 - 1ULL)) - 1ULL)) : (0ULL);
cp.code() += "if ((etiss_int32)(*((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rs1) + "ULL]) <= " + std::to_string(a) + "LL) { // conditional\n";
cp.code() += "*((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rd) + "ULL] = " + std::to_string(a) + "LL;\n";
cp.code() += "} // conditional\n";
cp.code() += " else if ((etiss_int32)(*((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rs1) + "ULL]) >= " + std::to_string(b) + "LL) { // conditional\n";
cp.code() += "*((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rd) + "ULL] = " + std::to_string(b) + "LL;\n";
cp.code() += "} // conditional\n";
cp.code() += "else { // conditional\n";
cp.code() += "*((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rd) + "ULL] = *((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rs1) + "ULL];\n";
...
{ // block
cp.code() += "{ // block\n";
cp.code() += "etiss_int32 a = -(((((*((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rs2) + "ULL]) >> (0ULL)) & 4294967295) + 1ULL));\n";
cp.code() += "etiss_int32 b = (((*((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rs2) + "ULL]) >> (0ULL)) & 4294967295);\n";
cp.code() += "if ((etiss_int32)(*((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rs1) + "ULL]) <= a) { // conditional\n";
cp.code() += "*((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rd) + "ULL] = a;\n";
cp.code() += "} // conditional\n";
cp.code() += " else if ((etiss_int32)(*((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rs1) + "ULL]) >= b) { // conditional\n";
cp.code() += "*((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rd) + "ULL] = b;\n";
cp.code() += "} // conditional\n";
cp.code() += "else { // conditional\n";
cp.code() += "*((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rd) + "ULL] = *((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rs1) + "ULL];\n";
cp.code() += "} // conditional\n";
...
{ // block
cp.code() += "{ // block\n";
cp.code() += "*((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rd) + "ULL] = (etiss_int32)((*((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rs1) + "ULL] + (((*((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rs2) + "ULL]) >> (0ULL)) & 4294967295))) >> " + std::to_string(Luimm5) + "ULL;\n";
cp.code() += "} // block\n";
} // block
} // conditional
cp.code() += "} // block\n";
...
{ // block
cp.code() += "{ // block\n";
cp.code() += "*((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rd) + "ULL] = (etiss_uint32)((*((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rs1) + "ULL] + (((*((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rs2) + "ULL]) >> (0ULL)) & 4294967295))) >> " + std::to_string(Luimm5) + "ULL;\n";
cp.code() += "} // block\n";
} // block
} // conditional
cp.code() += "} // block\n";
...
{ // block
cp.code() += "{ // block\n";
cp.code() += "*((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rd) + "ULL] = (etiss_int32)((*((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rs1) + "ULL] + (((*((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rs2) + "ULL]) >> (0ULL)) & 4294967295) + " + std::to_string((1ULL << (Luimm5 - 1ULL))) + "ULL)) >> " + std::to_string(Luimm5) + "ULL;\n";
cp.code() += "} // block\n";
} // block
} // conditional
cp.code() += "} // block\n";
...
{ // block
cp.code() += "{ // block\n";
cp.code() += "*((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rd) + "ULL] = (etiss_uint32)((*((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rs1) + "ULL] + (((*((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rs2) + "ULL]) >> (0ULL)) & 4294967295) + " + std::to_string((1ULL << (Luimm5 - 1ULL))) + "ULL)) >> " + std::to_string(Luimm5) + "ULL;\n";
cp.code() += "} // block\n";
} // block
} // conditional
cp.code() += "} // block\n";
...
{ // block
cp.code() += "{ // block\n";
cp.code() += "*((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rd) + "ULL] = (etiss_int32)((*((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rd) + "ULL] + *((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rs1) + "ULL])) >> ((((((*((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rs2) + "ULL]) >> (0ULL)) & 4294967295)) >> (0ULL)) & 31);\n";
cp.code() += "} // block\n";
} // block
} // conditional
cp.code() += "} // block\n";
...
{ // block
cp.code() += "{ // block\n";
cp.code() += "*((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rd) + "ULL] = (etiss_uint32)((*((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rd) + "ULL] + *((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rs1) + "ULL])) >> ((((((*((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rs2) + "ULL]) >> (0ULL)) & 4294967295)) >> (0ULL)) & 31);\n";
cp.code() += "} // block\n";
} // block
} // conditional
cp.code() += "} // block\n";
...
{ // block
cp.code() += "{ // block\n";
cp.code() += "*((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rd) + "ULL] = (etiss_int32)((*((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rd) + "ULL] + *((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rs1) + "ULL] + (1ULL << (((((((*((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rs2) + "ULL]) >> (0ULL)) & 4294967295)) >> (0ULL)) & 31) - 1ULL)))) >> ((((((*((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rs2) + "ULL]) >> (0ULL)) & 4294967295)) >> (0ULL)) & 31);\n";
cp.code() += "} // block\n";
} // block
} // conditional
cp.code() += "} // block\n";
...
{ // block
cp.code() += "{ // block\n";
cp.code() += "*((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rd) + "ULL] = (etiss_uint32)((*((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rd) + "ULL] + *((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rs1) + "ULL] + (1ULL << (((((((*((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rs2) + "ULL]) >> (0ULL)) & 4294967295)) >> (0ULL)) & 31) - 1ULL)))) >> ((((((*((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rs2) + "ULL]) >> (0ULL)) & 4294967295)) >> (0ULL)) & 31);\n";
cp.code() += "} // block\n";
} // block
} // conditional
cp.code() += "} // block\n";
