...
{ // procedure
cp.code() += "{ // procedure\n";
cp.code() += "raise(cpu, system, plugin_pointers, 0ULL, 8LL + ((RV32IMACFDXCoreV*)cpu)->PRIV);\n";
...
{ // block
cp.code() += "{ // block\n";
cp.code() += "if (((RV32IMACFDXCoreV*)cpu)->PRIV < 3LL) { // conditional\n";
{ // procedure
cp.code() += "{ // procedure\n";
...
{ // block
cp.code() += "{ // block\n";
cp.code() += "if (((RV32IMACFDXCoreV*)cpu)->PRIV < ((get_field(csr_read(cpu, system, plugin_pointers, 768LL), 4194304LL)) ? (3LL) : (1LL))) { // conditional\n";
{ // procedure
cp.code() += "{ // procedure\n";
cp.code() += "raise(cpu, system, plugin_pointers, 0ULL, 2LL);\n";
cp.code() += "goto instr_exit_" + std::to_string(ic.current_address_) + ";\n";
