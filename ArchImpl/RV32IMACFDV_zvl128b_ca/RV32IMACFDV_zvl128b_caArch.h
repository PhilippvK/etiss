...
#ifndef ETISS_RV32IMACFDV_zvl128b_caArch_RV32IMACFDV_zvl128b_caArch_H_
#define ETISS_RV32IMACFDV_zvl128b_caArch_RV32IMACFDV_zvl128b_caArch_H_
...
#include "RV32IMACFDV_zvl128b_caGDBCore.h"

#include <map>

extern const char * const reg_name[];

extern etiss::instr::InstructionGroup ISA16_RV32IMACFDV_zvl128b_ca;
extern etiss::instr::InstructionClass ISA16_RV32IMACFDV_zvl128b_caClass;
extern etiss::instr::InstructionGroup ISA32_RV32IMACFDV_zvl128b_ca;
extern etiss::instr::InstructionClass ISA32_RV32IMACFDV_zvl128b_caClass;

extern etiss::instr::InstructionCollection RV32IMACFDV_zvl128b_caISA;

class RV32IMACFDV_zvl128b_caArch : public etiss::CPUArch {

public:
	RV32IMACFDV_zvl128b_caArch(unsigned int);
	...
	/**
		...
		@see RV32IMACFDV_zvl128b_caArchSpecificImp.h
	*/
	...
	*/
	...
	/**
		@brief get the GDBcore for RV32IMACFDV_zvl128b_ca architecture

		@see RV32IMACFDV_zvl128b_caGDBCore.h for implementation of GDBcore
	*/
...
private:
	...
	RV32IMACFDV_zvl128b_caGDBCore gdbcore_;
