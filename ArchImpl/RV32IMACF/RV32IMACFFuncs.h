 ...
 *
 * This file contains the function macros for the RV32IMACF core architecture.
 */

#ifndef __RV32IMACF_FUNCS_H
#define __RV32IMACF_FUNCS_H

#ifndef ETISS_ARCH_STATIC_FN_ONLY
#include "Arch/RV32IMACF/RV32IMACF.h"
...
{
if (csr == 1U) {
return *((RV32IMACF*)cpu)->CSR[3U] & 31U;
}
if (csr == 2U) {
return (*((RV32IMACF*)cpu)->CSR[3U] >> 5U) & 7U;
}
if (csr == 3072U) {
...
{
if (csr == 1U) {
*((RV32IMACF*)cpu)->CSR[3] = (*((RV32IMACF*)cpu)->CSR[3U] & 224U) | (val & 31U);
} else if (csr == 2U) {
*((RV32IMACF*)cpu)->CSR[3] = ((val & 7U) << 5U) | (*((RV32IMACF*)cpu)->CSR[3U] & 31U);
} else if (csr == 3U) {
*((RV32IMACF*)cpu)->CSR[3] = val & 255U;
} else {
*((RV32IMACF*)cpu)->CSR[csr] = val;
}
}
#endif
#endif