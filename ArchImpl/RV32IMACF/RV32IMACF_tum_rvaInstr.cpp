...
partInit.code() += "((RV32IMACF*)cpu)->RES_ADDR = offs;\n";
if (rd) {
...
partInit.code() += "cpu->instructionPointer = " + std::to_string(ic.current_address_ + 4U) + ";\n";
partInit.code() += "etiss_uint32 offs = *((RV32IMACF*)cpu)->X[" + std::to_string(rs1 % 32U) + "];\n";
partInit.code() += "if (((RV32IMACF*)cpu)->RES_ADDR == offs) {\n";
...
partInit.code() += "}\n";
if (rd) {
partInit.code() += "*((RV32IMACF*)cpu)->X[" + std::to_string(rd % 32) + "] = ((RV32IMACF*)cpu)->RES_ADDR != offs;\n";
}
partInit.code() += "((RV32IMACF*)cpu)->RES_ADDR = -1;\n";
partInit.code() += "if (((RV32IMACF*)cpu)->exception) return ((RV32IMACF*)cpu)->exception;\n";
// -----------------------------------------------------------------------------
