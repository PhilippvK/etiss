 ...
 *
 * This file contains the GDBCore adapter for the RV32IMACF core architecture.
 *
 * WARNING: This file contains user-added code, be mindful when overwriting this with
 * generated code!
 */

#ifndef ETISS_RV32IMACFArch_RV32IMACFGDBCORE_H_
#define ETISS_RV32IMACFArch_RV32IMACFGDBCORE_H_

#include "etiss/IntegratedLibrary/gdb/GDBCore.h"
#include <sstream>

/**
	@brief This class is the brige between RV32IMACF architecture and gdbserver

	@details Gdbserver integrated in ETISS calls GDBCore to read/write registers via virtualStrruct
				The index in mapRegister() should strictly follow the RV32IMACF gdb tool defined register
				...
				virtualStruct in RV32IMACFArch.cpp should be modified as well as well

*/
class RV32IMACFGDBCore : public etiss::plugin::gdb::GDBCore {
public:
	...
	bool isLittleEndian(){
		// Modify according to RV32IMACF manual
		return true;
	}
};
