...
#ifndef ETISS_RV32IMACFArch_RV32IMACFArch_H_
#define ETISS_RV32IMACFArch_RV32IMACFArch_H_

#include "etiss/CPUArch.h"
#include "etiss/Instruction.h"
#include "etiss/InterruptVector.h"
#include "RV32IMACF.h"
#include "RV32IMACFGDBCore.h"

#include <map>

extern const char * const reg_name[];

extern etiss::instr::InstructionGroup ISA16_RV32IMACF;
extern etiss::instr::InstructionClass ISA16_RV32IMACFClass;
extern etiss::instr::InstructionGroup ISA32_RV32IMACF;
extern etiss::instr::InstructionClass ISA32_RV32IMACFClass;

extern etiss::instr::InstructionCollection RV32IMACFISA;

class RV32IMACFArch : public etiss::CPUArch {
...
public:
	...
	/**
		...
		@see RV32IMACFArchSpecificImp.h
	*/
	...
	*/
	...
	/**
		@brief get the GDBcore for RV32IMACF architecture

		@see RV32IMACFGDBCore.h for implementation of GDBcore
	*/
