...
{ // procedure
cp.code() += "{ // procedure\n";
cp.code() += "raise(cpu, system, plugin_pointers, 0ULL, 8LL + ((RV32IMAFDXCoreVHwlp*)cpu)->PRIV);\n";
cp.code() += "goto instr_exit_" + std::to_string(ic.current_address_) + ";\n";
cp.code() += "} // procedure\n";
} // procedure
cp.code() += "} // block\n";
...
{ // block
cp.code() += "{ // block\n";
cp.code() += "if (((RV32IMAFDXCoreVHwlp*)cpu)->PRIV < 3LL) { // conditional\n";
{ // procedure
cp.code() += "{ // procedure\n";
...
cp.code() += "} // conditional\n";
cp.code() += "cpu->nextPc = *((RV32IMAFDXCoreVHwlp*)cpu)->CSR[833LL];\n";
...
cp.code() += "((RV32IMAFDXCoreVHwlp*)cpu)->PRIV = (prev_prv) & 0x7;\n";
cp.code() += "} // block\n";
} // block
cp.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
cp.code() += "cpu->instructionPointer = cpu->nextPc;\n";
...
{ // block
cp.code() += "{ // block\n";
cp.code() += "if (((RV32IMAFDXCoreVHwlp*)cpu)->PRIV < ((get_field(csr_read(cpu, system, plugin_pointers, 768LL), 4194304LL)) ? (3LL) : (1LL))) { // conditional\n";
{ // procedure
cp.code() += "{ // procedure\n";
cp.code() += "raise(cpu, system, plugin_pointers, 0ULL, 2LL);\n";
cp.code() += "goto instr_exit_" + std::to_string(ic.current_address_) + ";\n";
...
cp.code() += "} // conditional\n";
cp.code() += "cpu->nextPc = *((RV32IMAFDXCoreVHwlp*)cpu)->CSR[321LL];\n";
