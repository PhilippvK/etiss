...
{ // block
cp.code() += "{ // block\n";
cp.code() += "((RV32IMAFDXCoreVHwlp*)cpu)->F[" + std::to_string(rd) + "ULL] = -4294967296LL | (etiss_uint64)(res);\n";
cp.code() += "} // block\n";
} // block
cp.code() += "} // block\n";
} // block
...
cp.code() += "etiss_uint32 offs = *((RV32IMAFDXCoreVHwlp*)cpu)->X[" + std::to_string(rs1 % 32ULL) + "ULL] + " + std::to_string(((etiss_int16)(((etiss_int16)imm) << (4)) >> (4))) + "LL;\n";
cp.code() += "etiss_uint32 mem_val_0;\n";
cp.code() += "mem_val_0 = (etiss_uint32)(((RV32IMAFDXCoreVHwlp*)cpu)->F[" + std::to_string(rs2) + "ULL]);\n";
...
{ // block
cp.code() += "{ // block\n";
cp.code() += "etiss_uint32 res = fmadd_s(unbox_s(((RV32IMAFDXCoreVHwlp*)cpu)->F[" + std::to_string(rs1) + "ULL]), unbox_s(((RV32IMAFDXCoreVHwlp*)cpu)->F[" + std::to_string(rs2) + "ULL]), unbox_s(((RV32IMAFDXCoreVHwlp*)cpu)->F[" + std::to_string(rs3) + "ULL]), 0ULL, get_rm(cpu, system, plugin_pointers, " + std::to_string(rm) + "ULL));\n";
cp.code() += "((RV32IMAFDXCoreVHwlp*)cpu)->F[" + std::to_string(rd) + "ULL] = -4294967296LL | (etiss_uint64)(res);\n";
cp.code() += "} // block\n";
} // block
...
{ // block
cp.code() += "{ // block\n";
cp.code() += "etiss_uint32 res = fmadd_s(unbox_s(((RV32IMAFDXCoreVHwlp*)cpu)->F[" + std::to_string(rs1) + "ULL]), unbox_s(((RV32IMAFDXCoreVHwlp*)cpu)->F[" + std::to_string(rs2) + "ULL]), unbox_s(((RV32IMAFDXCoreVHwlp*)cpu)->F[" + std::to_string(rs3) + "ULL]), 1ULL, get_rm(cpu, system, plugin_pointers, " + std::to_string(rm) + "ULL));\n";
cp.code() += "((RV32IMAFDXCoreVHwlp*)cpu)->F[" + std::to_string(rd) + "ULL] = -4294967296LL | (etiss_uint64)(res);\n";
cp.code() += "} // block\n";
} // block
cp.code() += "etiss_uint32 flags = fget_flags();\n";
...
{ // block
cp.code() += "{ // block\n";
cp.code() += "etiss_uint32 frs1 = unbox_s(((RV32IMAFDXCoreVHwlp*)cpu)->F[" + std::to_string(rs1) + "ULL]);\n";
cp.code() += "etiss_uint32 frs2 = unbox_s(((RV32IMAFDXCoreVHwlp*)cpu)->F[" + std::to_string(rs2) + "ULL]);\n";
cp.code() += "etiss_uint32 frs3 = unbox_s(((RV32IMAFDXCoreVHwlp*)cpu)->F[" + std::to_string(rs3) + "ULL]);\n";
...
if ((rd % 32ULL) != 0ULL) { // conditional
cp.code() += "*((RV32IMAFDXCoreVHwlp*)cpu)->X[" + std::to_string(rd % 32ULL) + "ULL] = (etiss_uint32)((etiss_int32)(res));\n";
} // conditional
cp.code() += "etiss_uint32 flags = fget_flags();\n";
cp.code() += "((RV32IMAFDXCoreVHwlp*)cpu)->FCSR = (((RV32IMAFDXCoreVHwlp*)cpu)->FCSR & -32LL) | (flags & 31ULL);\n";
cp.code() += "} // block\n";
...
cp.code() += "{ // block\n";
cp.code() += "etiss_uint32 res = 0ULL;\n";
cp.code() += "res = fclass_s(unbox_s(((RV32IMAFDXCoreVHwlp*)cpu)->F[" + std::to_string(rs1) + "ULL]));\n";
if ((rd % 32ULL) != 0ULL) { // conditional
cp.code() += "*((RV32IMAFDXCoreVHwlp*)cpu)->X[" + std::to_string(rd % 32ULL) + "ULL] = res;\n";
} // conditional
cp.code() += "} // block\n";
...
{ // block
cp.code() += "{ // block\n";
cp.code() += "etiss_uint32 res = fcvt_s((etiss_uint32)(*((RV32IMAFDXCoreVHwlp*)cpu)->X[" + std::to_string(rs1 % 32ULL) + "ULL]), 2ULL, " + std::to_string(rm) + "ULL);\n";
cp.code() += "((RV32IMAFDXCoreVHwlp*)cpu)->F[" + std::to_string(rd) + "ULL] = -4294967296LL | (etiss_uint64)(res);\n";
cp.code() += "} // block\n";
} // block
cp.code() += "} // block\n";
...
{ // block
cp.code() += "{ // block\n";
cp.code() += "etiss_uint32 res = fcvt_s((etiss_uint32)(*((RV32IMAFDXCoreVHwlp*)cpu)->X[" + std::to_string(rs1 % 32ULL) + "ULL]), 3ULL, " + std::to_string(rm) + "ULL);\n";
cp.code() += "((RV32IMAFDXCoreVHwlp*)cpu)->F[" + std::to_string(rd) + "ULL] = -4294967296LL | (etiss_uint64)(res);\n";
cp.code() += "} // block\n";
} // block
cp.code() += "} // block\n";
...
cp.code() += "{ // block\n";
if ((rd % 32ULL) != 0ULL) { // conditional
cp.code() += "*((RV32IMAFDXCoreVHwlp*)cpu)->X[" + std::to_string(rd % 32ULL) + "ULL] = (etiss_uint32)((etiss_int32)(((RV32IMAFDXCoreVHwlp*)cpu)->F[" + std::to_string(rs1) + "ULL]));\n";
} // conditional
cp.code() += "} // block\n";
} // block
cp.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
...
{ // block
cp.code() += "{ // block\n";
cp.code() += "((RV32IMAFDXCoreVHwlp*)cpu)->F[" + std::to_string(rd) + "ULL] = -4294967296LL | (etiss_uint64)(*((RV32IMAFDXCoreVHwlp*)cpu)->X[" + std::to_string(rs1 % 32ULL) + "ULL]);\n";
cp.code() += "} // block\n";
} // block
cp.code() += "} // block\n";
} // block
