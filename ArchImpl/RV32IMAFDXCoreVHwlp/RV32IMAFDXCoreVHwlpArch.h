...
#ifndef ETISS_RV32IMAFDXCoreVHwlpArch_RV32IMAFDXCoreVHwlpArch_H_
#define ETISS_RV32IMAFDXCoreVHwlpArch_RV32IMAFDXCoreVHwlpArch_H_

#include "etiss/CPUArch.h"
#include "etiss/Instruction.h"
#include "etiss/InterruptVector.h"
#include "etiss/InterruptEnable.h"
#include "RV32IMAFDXCoreVHwlp.h"
#include "RV32IMAFDXCoreVHwlpGDBCore.h"

#include <map>

extern const char * const reg_name[];

extern etiss::instr::InstructionGroup ISA32_RV32IMAFDXCoreVHwlp;
extern etiss::instr::InstructionClass ISA32_RV32IMAFDXCoreVHwlpClass;

extern etiss::instr::InstructionCollection RV32IMAFDXCoreVHwlpISA;

class RV32IMAFDXCoreVHwlpArch : public etiss::CPUArch {

public:
	RV32IMAFDXCoreVHwlpArch();
	...
	/**
		...
		@see RV32IMAFDXCoreVHwlpArchSpecificImp.h
	*/
	...
	*/
	...
	/**
		@brief get the GDBcore for RV32IMAFDXCoreVHwlp architecture

		@see RV32IMAFDXCoreVHwlpGDBCore.h for implementation of GDBcore
	*/
...
private:
	...
	RV32IMAFDXCoreVHwlpGDBCore gdbcore_;
};
#endif
