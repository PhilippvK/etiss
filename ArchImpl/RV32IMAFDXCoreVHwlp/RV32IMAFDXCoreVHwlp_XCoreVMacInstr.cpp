...
{ // block
cp.code() += "{ // block\n";
cp.code() += "etiss_int128 result = ((etiss_int32)(*((RV32IMAFDXCoreVHwlp*)cpu)->X[" + std::to_string(rs1) + "ULL]) * (etiss_int32)(*((RV32IMAFDXCoreVHwlp*)cpu)->X[" + std::to_string(rs2) + "ULL]) + (etiss_int32)(*((RV32IMAFDXCoreVHwlp*)cpu)->X[" + std::to_string(rd) + "ULL])) & 0x1ffffffffffffffff;\n";
if (rd != 0ULL) { // conditional
cp.code() += "*((RV32IMAFDXCoreVHwlp*)cpu)->X[" + std::to_string(rd) + "ULL] = (etiss_uint32)(result);\n";
} // conditional
cp.code() += "} // block\n";
} // block
...
{ // block
cp.code() += "{ // block\n";
cp.code() += "etiss_int64 result = (etiss_int32)(*((RV32IMAFDXCoreVHwlp*)cpu)->X[" + std::to_string(rd) + "ULL]) - (etiss_int32)(*((RV32IMAFDXCoreVHwlp*)cpu)->X[" + std::to_string(rs1) + "ULL]) * (etiss_int32)(*((RV32IMAFDXCoreVHwlp*)cpu)->X[" + std::to_string(rs2) + "ULL]);\n";
if (rd != 0ULL) { // conditional
cp.code() += "*((RV32IMAFDXCoreVHwlp*)cpu)->X[" + std::to_string(rd) + "ULL] = (((result) >> (0ULL)) & 4294967295);\n";
} // conditional
cp.code() += "} // block\n";
} // block
cp.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
...
{ // block
cp.code() += "{ // block\n";
cp.code() += "etiss_uint32 result = ((etiss_uint16)((((*((RV32IMAFDXCoreVHwlp*)cpu)->X[" + std::to_string(rs1) + "ULL]) >> (0ULL)) & 65535)) * (etiss_uint16)((((*((RV32IMAFDXCoreVHwlp*)cpu)->X[" + std::to_string(rs2) + "ULL]) >> (0ULL)) & 65535))) >> " + std::to_string(Is3) + "ULL;\n";
if (rd != 0ULL) { // conditional
cp.code() += "*((RV32IMAFDXCoreVHwlp*)cpu)->X[" + std::to_string(rd) + "ULL] = (((result) >> (0ULL)) & 4294967295);\n";
} // conditional
cp.code() += "} // block\n";
...
{ // block
cp.code() += "{ // block\n";
cp.code() += "etiss_uint32 result = ((etiss_uint16)((((*((RV32IMAFDXCoreVHwlp*)cpu)->X[" + std::to_string(rs1) + "ULL]) >> (16ULL)) & 65535)) * (etiss_uint16)((((*((RV32IMAFDXCoreVHwlp*)cpu)->X[" + std::to_string(rs2) + "ULL]) >> (16ULL)) & 65535))) >> " + std::to_string(Is3) + "ULL;\n";
if (rd != 0ULL) { // conditional
cp.code() += "*((RV32IMAFDXCoreVHwlp*)cpu)->X[" + std::to_string(rd) + "ULL] = (((result) >> (0ULL)) & 4294967295);\n";
} // conditional
cp.code() += "} // block\n";
...
{ // block
cp.code() += "{ // block\n";
cp.code() += "etiss_int32 result = ((etiss_int16)((((*((RV32IMAFDXCoreVHwlp*)cpu)->X[" + std::to_string(rs1) + "ULL]) >> (0ULL)) & 65535)) * (etiss_int16)((((*((RV32IMAFDXCoreVHwlp*)cpu)->X[" + std::to_string(rs2) + "ULL]) >> (0ULL)) & 65535))) >> " + std::to_string(Is3) + "ULL;\n";
if (rd != 0ULL) { // conditional
cp.code() += "*((RV32IMAFDXCoreVHwlp*)cpu)->X[" + std::to_string(rd) + "ULL] = (((result) >> (0ULL)) & 4294967295);\n";
} // conditional
cp.code() += "} // block\n";
...
{ // block
cp.code() += "{ // block\n";
cp.code() += "etiss_int32 result = ((etiss_int16)((((*((RV32IMAFDXCoreVHwlp*)cpu)->X[" + std::to_string(rs1) + "ULL]) >> (16ULL)) & 65535)) * (etiss_int16)((((*((RV32IMAFDXCoreVHwlp*)cpu)->X[" + std::to_string(rs2) + "ULL]) >> (16ULL)) & 65535))) >> " + std::to_string(Is3) + "ULL;\n";
if (rd != 0ULL) { // conditional
cp.code() += "*((RV32IMAFDXCoreVHwlp*)cpu)->X[" + std::to_string(rd) + "ULL] = (((result) >> (0ULL)) & 4294967295);\n";
} // conditional
cp.code() += "} // block\n";
...
{ // block
cp.code() += "{ // block\n";
cp.code() += "etiss_int32 product = ((etiss_uint16)((((*((RV32IMAFDXCoreVHwlp*)cpu)->X[" + std::to_string(rs1) + "ULL]) >> (0ULL)) & 65535)) * (etiss_uint16)((((*((RV32IMAFDXCoreVHwlp*)cpu)->X[" + std::to_string(rs2) + "ULL]) >> (0ULL)) & 65535))) & 0x7fffffff;\n";
...
cp.code() += "*((RV32IMAFDXCoreVHwlp*)cpu)->X[" + std::to_string(rd) + "ULL] = (((rounded) >> (0ULL)) & 4294967295);\n";
cp.code() += "} // block\n";
} // block
cp.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
cp.code() += "cpu->instructionPointer = cpu->nextPc;\n";
...
{ // block
cp.code() += "{ // block\n";
cp.code() += "etiss_int32 product = ((etiss_uint16)((((*((RV32IMAFDXCoreVHwlp*)cpu)->X[" + std::to_string(rs1) + "ULL]) >> (16ULL)) & 65535)) * (etiss_uint16)((((*((RV32IMAFDXCoreVHwlp*)cpu)->X[" + std::to_string(rs2) + "ULL]) >> (16ULL)) & 65535))) & 0x7fffffff;\n";
etiss_uint32 powerOf2 = (1ULL << (Is3 - 1ULL)) & 0x3fffffff;
cp.code() += "etiss_uint32 sum = product + " + std::to_string(powerOf2) + "ULL;\n";
cp.code() += "etiss_uint32 rounded = sum >> " + std::to_string(Is3) + "ULL;\n";
cp.code() += "*((RV32IMAFDXCoreVHwlp*)cpu)->X[" + std::to_string(rd) + "ULL] = (((rounded) >> (0ULL)) & 4294967295);\n";
...
{ // block
cp.code() += "{ // block\n";
cp.code() += "etiss_int32 product = ((etiss_int16)((((*((RV32IMAFDXCoreVHwlp*)cpu)->X[" + std::to_string(rs1) + "ULL]) >> (0ULL)) & 65535)) * (etiss_int16)((((*((RV32IMAFDXCoreVHwlp*)cpu)->X[" + std::to_string(rs2) + "ULL]) >> (0ULL)) & 65535))) & 0x7fffffff;\n";
etiss_uint32 powerOf2 = (1ULL << (Is3 - 1ULL)) & 0x3fffffff;
...
{ // block
cp.code() += "{ // block\n";
cp.code() += "etiss_int32 product = ((etiss_int16)((((*((RV32IMAFDXCoreVHwlp*)cpu)->X[" + std::to_string(rs1) + "ULL]) >> (16ULL)) & 65535)) * (etiss_int16)((((*((RV32IMAFDXCoreVHwlp*)cpu)->X[" + std::to_string(rs2) + "ULL]) >> (16ULL)) & 65535))) & 0x7fffffff;\n";
etiss_uint32 powerOf2 = (1ULL << (Is3 - 1ULL)) & 0x3fffffff;
cp.code() += "etiss_int32 sum = product + " + std::to_string(powerOf2) + "ULL;\n";
cp.code() += "etiss_int32 rounded = sum >> " + std::to_string(Is3) + "ULL;\n";
cp.code() += "*((RV32IMAFDXCoreVHwlp*)cpu)->X[" + std::to_string(rd) + "ULL] = (((rounded) >> (0ULL)) & 4294967295);\n";
...
{ // block
cp.code() += "{ // block\n";
cp.code() += "etiss_uint32 result = ((etiss_uint16)((((*((RV32IMAFDXCoreVHwlp*)cpu)->X[" + std::to_string(rs1) + "ULL]) >> (0ULL)) & 65535)) * (etiss_uint16)((((*((RV32IMAFDXCoreVHwlp*)cpu)->X[" + std::to_string(rs2) + "ULL]) >> (0ULL)) & 65535)) + (etiss_uint32)(*((RV32IMAFDXCoreVHwlp*)cpu)->X[" + std::to_string(rd) + "ULL])) >> " + std::to_string(Is3) + "ULL;\n";
if (rd != 0ULL) { // conditional
cp.code() += "*((RV32IMAFDXCoreVHwlp*)cpu)->X[" + std::to_string(rd) + "ULL] = (((result) >> (0ULL)) & 4294967295);\n";
} // conditional
cp.code() += "} // block\n";
...
{ // block
cp.code() += "{ // block\n";
cp.code() += "etiss_uint32 result = ((etiss_uint16)((((*((RV32IMAFDXCoreVHwlp*)cpu)->X[" + std::to_string(rs1) + "ULL]) >> (16ULL)) & 65535)) * (etiss_uint16)((((*((RV32IMAFDXCoreVHwlp*)cpu)->X[" + std::to_string(rs2) + "ULL]) >> (16ULL)) & 65535)) + (etiss_uint32)(*((RV32IMAFDXCoreVHwlp*)cpu)->X[" + std::to_string(rd) + "ULL])) >> " + std::to_string(Is3) + "ULL;\n";
if (rd != 0ULL) { // conditional
cp.code() += "*((RV32IMAFDXCoreVHwlp*)cpu)->X[" + std::to_string(rd) + "ULL] = (((result) >> (0ULL)) & 4294967295);\n";
} // conditional
cp.code() += "} // block\n";
...
{ // block
cp.code() += "{ // block\n";
cp.code() += "etiss_int32 result = ((etiss_int16)((((*((RV32IMAFDXCoreVHwlp*)cpu)->X[" + std::to_string(rs1) + "ULL]) >> (0ULL)) & 65535)) * (etiss_int16)((((*((RV32IMAFDXCoreVHwlp*)cpu)->X[" + std::to_string(rs2) + "ULL]) >> (0ULL)) & 65535)) + (etiss_int32)(*((RV32IMAFDXCoreVHwlp*)cpu)->X[" + std::to_string(rd) + "ULL])) >> " + std::to_string(Is3) + "ULL;\n";
if (rd != 0ULL) { // conditional
cp.code() += "*((RV32IMAFDXCoreVHwlp*)cpu)->X[" + std::to_string(rd) + "ULL] = (((result) >> (0ULL)) & 4294967295);\n";
} // conditional
cp.code() += "} // block\n";
...
{ // block
cp.code() += "{ // block\n";
cp.code() += "etiss_int32 result = ((etiss_int16)((((*((RV32IMAFDXCoreVHwlp*)cpu)->X[" + std::to_string(rs1) + "ULL]) >> (16ULL)) & 65535)) * (etiss_int16)((((*((RV32IMAFDXCoreVHwlp*)cpu)->X[" + std::to_string(rs2) + "ULL]) >> (16ULL)) & 65535)) + (etiss_int32)(*((RV32IMAFDXCoreVHwlp*)cpu)->X[" + std::to_string(rd) + "ULL])) >> " + std::to_string(Is3) + "ULL;\n";
if (rd != 0ULL) { // conditional
cp.code() += "*((RV32IMAFDXCoreVHwlp*)cpu)->X[" + std::to_string(rd) + "ULL] = (((result) >> (0ULL)) & 4294967295);\n";
} // conditional
cp.code() += "} // block\n";
...
{ // block
cp.code() += "{ // block\n";
cp.code() += "etiss_uint32 product = ((etiss_uint16)(((((*((RV32IMAFDXCoreVHwlp*)cpu)->X[" + std::to_string(rs1) + "ULL]) >> (0ULL)) & 65535))) * (etiss_uint16)(((((*((RV32IMAFDXCoreVHwlp*)cpu)->X[" + std::to_string(rs2) + "ULL]) >> (0ULL)) & 65535)))) & 0x3fffffff;\n";
etiss_uint32 powerOf2 = (1ULL << (Is3 - 1ULL)) & 0x3fffffff;
cp.code() += "etiss_uint64 sum = (product + (etiss_uint32)(*((RV32IMAFDXCoreVHwlp*)cpu)->X[" + std::to_string(rd) + "ULL]) + " + std::to_string(powerOf2) + "ULL) & 0x1ffffffff;\n";
...
{ // block
cp.code() += "{ // block\n";
cp.code() += "etiss_uint32 product = ((etiss_uint16)(((((*((RV32IMAFDXCoreVHwlp*)cpu)->X[" + std::to_string(rs1) + "ULL]) >> (16ULL)) & 65535))) * (etiss_uint16)(((((*((RV32IMAFDXCoreVHwlp*)cpu)->X[" + std::to_string(rs2) + "ULL]) >> (16ULL)) & 65535)))) & 0x3fffffff;\n";
etiss_uint32 powerOf2 = (1ULL << (Is3 - 1ULL)) & 0x3fffffff;
cp.code() += "etiss_uint64 sum = (product + (etiss_uint32)(*((RV32IMAFDXCoreVHwlp*)cpu)->X[" + std::to_string(rd) + "ULL]) + " + std::to_string(powerOf2) + "ULL) & 0x1ffffffff;\n";
cp.code() += "etiss_uint64 rounded = (sum >> " + std::to_string(Is3) + "ULL) & 0x1ffffffff;\n";
cp.code() += "*((RV32IMAFDXCoreVHwlp*)cpu)->X[" + std::to_string(rd) + "ULL] = (((rounded) >> (0ULL)) & 4294967295);\n";
...
cp.code() += "etiss_int32 product = ((etiss_int16)((((*((RV32IMAFDXCoreVHwlp*)cpu)->X[" + std::to_string(rs1) + "ULL]) >> (0ULL)) & 65535)) * (etiss_int16)((((*((RV32IMAFDXCoreVHwlp*)cpu)->X[" + std::to_string(rs2) + "ULL]) >> (0ULL)) & 65535))) & 0x7fffffff;\n";
etiss_uint32 powerOf2 = (1ULL << (Is3 - 1ULL)) & 0x3fffffff;
cp.code() += "etiss_int32 sum = product + (etiss_int32)(*((RV32IMAFDXCoreVHwlp*)cpu)->X[" + std::to_string(rd) + "ULL]) + " + std::to_string(powerOf2) + "ULL;\n";
cp.code() += "etiss_int32 rounded = sum >> " + std::to_string(Is3) + "ULL;\n";
cp.code() += "*((RV32IMAFDXCoreVHwlp*)cpu)->X[" + std::to_string(rd) + "ULL] = (((rounded) >> (0ULL)) & 4294967295);\n";
cp.code() += "} // block\n";
} // block
