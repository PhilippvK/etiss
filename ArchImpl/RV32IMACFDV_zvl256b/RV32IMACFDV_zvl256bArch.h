...
#ifndef ETISS_RV32IMACFDV_zvl256bArch_RV32IMACFDV_zvl256bArch_H_
#define ETISS_RV32IMACFDV_zvl256bArch_RV32IMACFDV_zvl256bArch_H_
...
#include "RV32IMACFDV_zvl256bGDBCore.h"

#include <map>

extern const char * const reg_name[];

extern etiss::instr::InstructionGroup ISA16_RV32IMACFDV_zvl256b;
extern etiss::instr::InstructionClass ISA16_RV32IMACFDV_zvl256bClass;
extern etiss::instr::InstructionGroup ISA32_RV32IMACFDV_zvl256b;
extern etiss::instr::InstructionClass ISA32_RV32IMACFDV_zvl256bClass;

extern etiss::instr::InstructionCollection RV32IMACFDV_zvl256bISA;

class RV32IMACFDV_zvl256bArch : public etiss::CPUArch {

public:
	RV32IMACFDV_zvl256bArch(unsigned int);
	...
	/**
		...
		@see RV32IMACFDV_zvl256bArchSpecificImp.h
	*/
	...
	*/
	...
	/**
		@brief get the GDBcore for RV32IMACFDV_zvl256b architecture

		@see RV32IMACFDV_zvl256bGDBCore.h for implementation of GDBcore
	*/
...
private:
	...
	RV32IMACFDV_zvl256bGDBCore gdbcore_;
