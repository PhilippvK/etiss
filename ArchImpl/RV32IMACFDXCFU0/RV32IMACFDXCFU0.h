...
#ifndef ETISS_RV32IMACFDXCFU0Arch_RV32IMACFDXCFU0_H_
#define ETISS_RV32IMACFDXCFU0Arch_RV32IMACFDXCFU0_H_
#include <stdio.h>
...
struct RV32IMACFDXCFU0 {
	...
	etiss_uint64 F[32];
	etiss_uint8 clusters[4];
	etiss_uint64 weight_code_packed;
	etiss_uint32 acc;
	etiss_uint32 RES_ADDR;
};

#pragma pack(pop) // undo changes
typedef struct RV32IMACFDXCFU0 RV32IMACFDXCFU0; // convenient use of X instead of struct X in generated C code
#ifdef __cplusplus
} // extern "C"
#endif
#endif
