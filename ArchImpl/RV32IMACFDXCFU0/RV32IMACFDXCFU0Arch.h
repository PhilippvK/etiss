...
#ifndef ETISS_RV32IMACFDXCFU0Arch_RV32IMACFDXCFU0Arch_H_
#define ETISS_RV32IMACFDXCFU0Arch_RV32IMACFDXCFU0Arch_H_

#include "etiss/CPUArch.h"
#include "etiss/Instruction.h"
#include "etiss/InterruptVector.h"
#include "etiss/InterruptEnable.h"
#include "RV32IMACFDXCFU0.h"
#include "RV32IMACFDXCFU0GDBCore.h"

#include <map>

extern const char * const reg_name[];

extern etiss::instr::InstructionGroup ISA16_RV32IMACFDXCFU0;
extern etiss::instr::InstructionClass ISA16_RV32IMACFDXCFU0Class;
extern etiss::instr::InstructionGroup ISA32_RV32IMACFDXCFU0;
extern etiss::instr::InstructionClass ISA32_RV32IMACFDXCFU0Class;

extern etiss::instr::InstructionCollection RV32IMACFDXCFU0ISA;

class RV32IMACFDXCFU0Arch : public etiss::CPUArch {

public:
	RV32IMACFDXCFU0Arch(unsigned int);
	...
	/**
		...
		@see RV32IMACFDXCFU0ArchSpecificImp.h
	*/
	...
	*/
	...
	/**
		@brief get the GDBcore for RV32IMACFDXCFU0 architecture

		@see RV32IMACFDXCFU0GDBCore.h for implementation of GDBcore
	*/
...
private:
	...
	RV32IMACFDXCFU0GDBCore gdbcore_;
