...
{ // block
cp.code() += "etiss_coverage_count(1, 4901);\n";
cp.code() += "{ // block\n";
cp.code() += "etiss_uint32 offs = *((RV32IMACFDXCFU0*)cpu)->X[" + std::to_string(rs1 + 8ULL) + "ULL] + " + std::to_string(uimm) + "ULL;\n";
cp.code() += "etiss_coverage_count(7, 4866, 4865, 4863, 4862, 4860, 4861, 4864);\n";
...
cp.code() += "etiss_coverage_count(4, 4873, 4872, 4870, 4869);\n";
{ // block
cp.code() += "etiss_coverage_count(1, 4900);\n";
cp.code() += "{ // block\n";
cp.code() += "((RV32IMACFDXCFU0*)cpu)->F[" + std::to_string(rd + 8ULL) + "ULL] = -4294967296LL | res;\n";
cp.code() += "etiss_coverage_count(7, 4899, 4889, 4888, 4886, 4887, 4898, 4897);\n";
cp.code() += "} // block\n";
} // block
cp.code() += "} // block\n";
} // block
...
{ // block
cp.code() += "etiss_coverage_count(1, 4922);\n";
cp.code() += "{ // block\n";
cp.code() += "etiss_uint32 offs = *((RV32IMACFDXCFU0*)cpu)->X[" + std::to_string(rs1 + 8ULL) + "ULL] + " + std::to_string(uimm) + "ULL;\n";
cp.code() += "etiss_coverage_count(7, 4910, 4909, 4907, 4906, 4904, 4905, 4908);\n";
cp.code() += "etiss_uint32 mem_val_0;\n";
cp.code() += "mem_val_0 = (etiss_uint32)(((RV32IMACFDXCFU0*)cpu)->F[" + std::to_string(rs2 + 8ULL) + "ULL]);\n";
cp.code() += "etiss_coverage_count(8, 4921, 4913, 4912, 4920, 4918, 4917, 4915, 4916);\n";
...
{ // block
cp.code() += "etiss_coverage_count(1, 4960);\n";
cp.code() += "{ // block\n";
cp.code() += "etiss_uint32 offs = *((RV32IMACFDXCFU0*)cpu)->X[2ULL] + " + std::to_string(uimm) + "ULL;\n";
cp.code() += "etiss_coverage_count(5, 4929, 4928, 4926, 4925, 4927);\n";
cp.code() += "etiss_uint32 mem_val_0;\n";
cp.code() += "cpu->exception |= (*(system->dread))(system->handle, cpu, offs, (etiss_uint8*)&mem_val_0, 4);\n";
cp.code() += "if (cpu->exception) { // conditional\n";
{ // procedure
...
cp.code() += "} // conditional\n";
cp.code() += "etiss_uint32 res = (etiss_uint32)(mem_val_0);\n";
cp.code() += "etiss_coverage_count(4, 4936, 4935, 4933, 4932);\n";
{ // block
cp.code() += "etiss_coverage_count(1, 4959);\n";
cp.code() += "{ // block\n";
cp.code() += "((RV32IMACFDXCFU0*)cpu)->F[" + std::to_string(rd) + "ULL] = -4294967296LL | res;\n";
cp.code() += "etiss_coverage_count(5, 4958, 4948, 4947, 4957, 4956);\n";
cp.code() += "} // block\n";
} // block
cp.code() += "} // block\n";
} // block
...
{ // block
cp.code() += "etiss_coverage_count(1, 4977);\n";
cp.code() += "{ // block\n";
cp.code() += "etiss_uint32 offs = *((RV32IMACFDXCFU0*)cpu)->X[2ULL] + " + std::to_string(uimm) + "ULL;\n";
cp.code() += "etiss_coverage_count(5, 4967, 4966, 4964, 4963, 4965);\n";
cp.code() += "etiss_uint32 mem_val_0;\n";
cp.code() += "mem_val_0 = (etiss_uint32)(((RV32IMACFDXCFU0*)cpu)->F[" + std::to_string(rs2) + "ULL]);\n";
cp.code() += "etiss_coverage_count(6, 4976, 4970, 4969, 4975, 4973, 4972);\n";
cp.code() += "cpu->exception |= (*(system->dwrite))(system->handle, cpu, offs, (etiss_uint8*)&mem_val_0, 4);\n";
cp.code() += "if (cpu->exception) { // conditional\n";
{ // procedure
cp.code() += "{ // procedure\n";
