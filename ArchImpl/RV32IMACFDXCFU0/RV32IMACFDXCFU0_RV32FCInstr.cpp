...
{ // block
cp.code() += "etiss_coverage_count(1, 4899);\n";
cp.code() += "{ // block\n";
cp.code() += "etiss_uint32 offs = *((RV32IMACFDXCFU0*)cpu)->X[" + std::to_string(rs1 + 8ULL) + "ULL] + " + std::to_string(uimm) + "ULL;\n";
cp.code() += "etiss_coverage_count(7, 4864, 4863, 4861, 4860, 4858, 4859, 4862);\n";
...
cp.code() += "etiss_coverage_count(4, 4871, 4870, 4868, 4867);\n";
{ // block
cp.code() += "etiss_coverage_count(1, 4898);\n";
cp.code() += "{ // block\n";
cp.code() += "((RV32IMACFDXCFU0*)cpu)->F[" + std::to_string(rd + 8ULL) + "ULL] = -4294967296LL | res;\n";
cp.code() += "etiss_coverage_count(7, 4897, 4887, 4886, 4884, 4885, 4896, 4895);\n";
cp.code() += "} // block\n";
} // block
cp.code() += "} // block\n";
} // block
...
{ // block
cp.code() += "etiss_coverage_count(1, 4920);\n";
cp.code() += "{ // block\n";
cp.code() += "etiss_uint32 offs = *((RV32IMACFDXCFU0*)cpu)->X[" + std::to_string(rs1 + 8ULL) + "ULL] + " + std::to_string(uimm) + "ULL;\n";
cp.code() += "etiss_coverage_count(7, 4908, 4907, 4905, 4904, 4902, 4903, 4906);\n";
cp.code() += "etiss_uint32 mem_val_0;\n";
cp.code() += "mem_val_0 = (etiss_uint32)(((RV32IMACFDXCFU0*)cpu)->F[" + std::to_string(rs2 + 8ULL) + "ULL]);\n";
cp.code() += "etiss_coverage_count(8, 4919, 4911, 4910, 4918, 4916, 4915, 4913, 4914);\n";
...
{ // block
cp.code() += "etiss_coverage_count(1, 4958);\n";
cp.code() += "{ // block\n";
cp.code() += "etiss_uint32 offs = *((RV32IMACFDXCFU0*)cpu)->X[2ULL] + " + std::to_string(uimm) + "ULL;\n";
cp.code() += "etiss_coverage_count(5, 4927, 4926, 4924, 4923, 4925);\n";
cp.code() += "etiss_uint32 mem_val_0;\n";
cp.code() += "cpu->exception |= (*(system->dread))(system->handle, cpu, offs, (etiss_uint8*)&mem_val_0, 4);\n";
cp.code() += "if (cpu->exception) { // conditional\n";
{ // procedure
...
cp.code() += "} // conditional\n";
cp.code() += "etiss_uint32 res = (etiss_uint32)(mem_val_0);\n";
cp.code() += "etiss_coverage_count(4, 4934, 4933, 4931, 4930);\n";
{ // block
cp.code() += "etiss_coverage_count(1, 4957);\n";
cp.code() += "{ // block\n";
cp.code() += "((RV32IMACFDXCFU0*)cpu)->F[" + std::to_string(rd) + "ULL] = -4294967296LL | res;\n";
cp.code() += "etiss_coverage_count(5, 4956, 4946, 4945, 4955, 4954);\n";
cp.code() += "} // block\n";
} // block
cp.code() += "} // block\n";
} // block
...
{ // block
cp.code() += "etiss_coverage_count(1, 4975);\n";
cp.code() += "{ // block\n";
cp.code() += "etiss_uint32 offs = *((RV32IMACFDXCFU0*)cpu)->X[2ULL] + " + std::to_string(uimm) + "ULL;\n";
cp.code() += "etiss_coverage_count(5, 4965, 4964, 4962, 4961, 4963);\n";
cp.code() += "etiss_uint32 mem_val_0;\n";
cp.code() += "mem_val_0 = (etiss_uint32)(((RV32IMACFDXCFU0*)cpu)->F[" + std::to_string(rs2) + "ULL]);\n";
cp.code() += "etiss_coverage_count(6, 4974, 4968, 4967, 4973, 4971, 4970);\n";
cp.code() += "cpu->exception |= (*(system->dwrite))(system->handle, cpu, offs, (etiss_uint8*)&mem_val_0, 4);\n";
cp.code() += "if (cpu->exception) { // conditional\n";
{ // procedure
cp.code() += "{ // procedure\n";
