 ...
 *
 * This file contains the library interface for the RV32IMACFDXCFU0 core architecture.
 */
...
#define ETISS_LIBNAME RV32IMACFDXCFU0
...
extern "C" {
	...
	ETISS_PLUGIN_EXPORT unsigned RV32IMACFDXCFU0_countCPUArch()
	{
//TODO
		return 1; // number of cpu architectures provided
	}
	ETISS_PLUGIN_EXPORT const char * RV32IMACFDXCFU0_nameCPUArch(unsigned index)
	{
//TODO
		switch (index)
		{
		case 0:
			return "RV32IMACFDXCFU0";
		default:
			return "";
		}
	}
	ETISS_PLUGIN_EXPORT etiss::CPUArch* RV32IMACFDXCFU0_createCPUArch(unsigned index,std::map<std::string,std::string> options)
	{
//TODO
		switch (index)
		{
		case 0:
			{
				...
				return new RV32IMACFDXCFU0Arch(coreno);
			}
		default:
			return 0;
		}
	}
	ETISS_PLUGIN_EXPORT void RV32IMACFDXCFU0_deleteCPUArch(etiss::CPUArch* arch)
	{
		delete arch;
	}
}
