 ...
 *
 * This file contains the GDBCore adapter for the RV32IMACFDXCFU0 core architecture.
 *
 * WARNING: This file contains user-added code, be mindful when overwriting this with
 * generated code!
 */

#ifndef ETISS_RV32IMACFDXCFU0Arch_RV32IMACFDXCFU0GDBCORE_H_
#define ETISS_RV32IMACFDXCFU0Arch_RV32IMACFDXCFU0GDBCORE_H_

#include "etiss/IntegratedLibrary/gdb/GDBCore.h"
#include <sstream>

/**
	@brief This class is the brige between RV32IMACFDXCFU0 architecture and gdbserver

	@details Gdbserver integrated in ETISS calls GDBCore to read/write registers via virtualStrruct
				The index in mapRegister() should strictly follow the RV32IMACFDXCFU0 gdb tool defined register
				...
				virtualStruct in RV32IMACFDXCFU0Arch.cpp should be modified as well as well

*/
class RV32IMACFDXCFU0GDBCore : public etiss::plugin::gdb::GDBCore {
public:
	...
	bool isLittleEndian(){
		// Modify according to RV32IMACFDXCFU0 manual
		return true;
	}
};
