...
cp.code() += "*((RV32IMAFDXCoreVHwlpV0*)cpu)->X[" + std::to_string(rd) + "ULL] = (etiss_uint32)(res);\n";
} // conditional
...
cp.code() += "*((RV32IMAFDXCoreVHwlpV0*)cpu)->X[" + std::to_string(rs1) + "ULL] = *((RV32IMAFDXCoreVHwlpV0*)cpu)->X[" + std::to_string(rs1) + "ULL] + (etiss_int32)(*((RV32IMAFDXCoreVHwlpV0*)cpu)->X[" + std::to_string(rs2) + "ULL]);\n";
cp.code() += "} // block\n";
} // block
cp.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
cp.code() += "cpu->instructionPointer = cpu->nextPc;\n";
