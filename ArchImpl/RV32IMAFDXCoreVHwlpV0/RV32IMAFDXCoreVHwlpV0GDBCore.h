...
#ifndef ETISS_RV32IMAFDXCoreVHwlpV0Arch_RV32IMAFDXCoreVHwlpV0GDBCORE_H_
#define ETISS_RV32IMAFDXCoreVHwlpV0Arch_RV32IMAFDXCoreVHwlpV0GDBCORE_H_

#include "etiss/IntegratedLibrary/gdb/GDBCore.h"
#include <sstream>

/**
	@brief This class is the brige between RV32IMAFDXCoreVHwlpV0 architecture and gdbserver

	@details Gdbserver integrated in ETISS calls GDBCore to read/write registers via virtualStrruct
				The index in mapRegister() should strictly follow the RV32IMAFDXCoreVHwlpV0 gdb tool defined register
				...
				virtualStruct in RV32IMAFDXCoreVHwlpV0Arch.cpp should be modified as well as well

*/
class RV32IMAFDXCoreVHwlpV0GDBCore : public etiss::plugin::gdb::GDBCore {
public:
	...
	bool isLittleEndian(){
		// Modify according to RV32IMAFDXCoreVHwlpV0 manual
		return true;
	}
};
