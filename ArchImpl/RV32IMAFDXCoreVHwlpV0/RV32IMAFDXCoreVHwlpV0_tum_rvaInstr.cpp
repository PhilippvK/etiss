...
if (rd) { // conditional
cp.code() += "*((RV32IMAFDXCoreVHwlpV0*)cpu)->X[" + std::to_string(rd % 32ULL) + "ULL] = (etiss_int32)(res);\n";
} // conditional
cp.code() += "} // block\n";
} // block
...
cp.code() += "} // conditional\n";
if (rd) { // conditional
cp.code() += "*((RV32IMAFDXCoreVHwlpV0*)cpu)->X[" + std::to_string(rd % 32ULL) + "ULL] = ((RV32IMAFDXCoreVHwlpV0*)cpu)->RES_ADDR != offs;\n";
} // conditional
cp.code() += "((RV32IMAFDXCoreVHwlpV0*)cpu)->RES_ADDR = -1LL;\n";
cp.code() += "} // block\n";
} // block
cp.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
cp.code() += "cpu->instructionPointer = cpu->nextPc;\n";
