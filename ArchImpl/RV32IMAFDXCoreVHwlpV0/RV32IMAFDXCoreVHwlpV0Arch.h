...
#ifndef ETISS_RV32IMAFDXCoreVHwlpV0Arch_RV32IMAFDXCoreVHwlpV0Arch_H_
#define ETISS_RV32IMAFDXCoreVHwlpV0Arch_RV32IMAFDXCoreVHwlpV0Arch_H_

#include "etiss/CPUArch.h"
#include "etiss/Instruction.h"
#include "etiss/InterruptVector.h"
#include "etiss/InterruptEnable.h"
#include "RV32IMAFDXCoreVHwlpV0.h"
#include "RV32IMAFDXCoreVHwlpV0GDBCore.h"

#include <map>

extern const char * const reg_name[];

extern etiss::instr::InstructionGroup ISA32_RV32IMAFDXCoreVHwlpV0;
extern etiss::instr::InstructionClass ISA32_RV32IMAFDXCoreVHwlpV0Class;

extern etiss::instr::InstructionCollection RV32IMAFDXCoreVHwlpV0ISA;

class RV32IMAFDXCoreVHwlpV0Arch : public etiss::CPUArch {
...
public:
	...
	/**
		...
		@see RV32IMAFDXCoreVHwlpV0ArchSpecificImp.h
	*/
	...
	*/
	...
	/**
		@brief get the GDBcore for RV32IMAFDXCoreVHwlpV0 architecture

		@see RV32IMAFDXCoreVHwlpV0GDBCore.h for implementation of GDBcore
	*/
...
private:
	...
	RV32IMAFDXCoreVHwlpV0GDBCore gdbcore_;
};
#endif
