...
{ // block
cp.code() += "etiss_coverage_count(1, 8384);\n";
cp.code() += "{ // block\n";
cp.code() += "etiss_uint64 offs = *((RV64IMACFD*)cpu)->X[" + std::to_string(rs1 % 32ULL) + "ULL];\n";
cp.code() += "etiss_coverage_count(4, 8362, 8361, 8360, 8358);\n";
...
cp.code() += "etiss_coverage_count(4, 8369, 8368, 8366, 8365);\n";
cp.code() += "((RV64IMACFD*)cpu)->RES_ADDR = offs;\n";
cp.code() += "etiss_coverage_count(3, 8372, 8370, 8371);\n";
cp.code() += "etiss_coverage_count(1, 8373);\n";
if (rd) { // conditional
cp.code() += "etiss_coverage_count(1, 8374);\n";
cp.code() += "*((RV64IMACFD*)cpu)->X[" + std::to_string(rd % 32ULL) + "ULL] = (etiss_int64)(res);\n";
cp.code() += "etiss_coverage_count(6, 8383, 8379, 8378, 8376, 8382, 8380);\n";
} // conditional
cp.code() += "} // block\n";
} // block
...
cp.code() += "{ // block\n";
cp.code() += "etiss_uint64 offs = *((RV64IMACFD*)cpu)->X[" + std::to_string(rs1 % 32ULL) + "ULL];\n";
cp.code() += "etiss_coverage_count(4, 8391, 8390, 8389, 8387);\n";
cp.code() += "etiss_coverage_count(1, 8392);\n";
cp.code() += "if (((RV64IMACFD*)cpu)->RES_ADDR == offs) { // conditional\n";
cp.code() += "etiss_coverage_count(3, 8395, 8393, 8394);\n";
cp.code() += "etiss_uint64 mem_val_0;\n";
cp.code() += "mem_val_0 = (etiss_int64)(*((RV64IMACFD*)cpu)->X[" + std::to_string(rs2 % 32ULL) + "ULL]);\n";
cp.code() += "etiss_coverage_count(7, 8406, 8398, 8397, 8405, 8403, 8402, 8400);\n";
...
cp.code() += "} // conditional\n";
cp.code() += "} // conditional\n";
cp.code() += "etiss_coverage_count(1, 8407);\n";
if (rd) { // conditional
cp.code() += "etiss_coverage_count(1, 8408);\n";
cp.code() += "*((RV64IMACFD*)cpu)->X[" + std::to_string(rd % 32ULL) + "ULL] = ((RV64IMACFD*)cpu)->RES_ADDR != offs;\n";
cp.code() += "etiss_coverage_count(7, 8417, 8413, 8412, 8410, 8416, 8414, 8415);\n";
} // conditional
cp.code() += "((RV64IMACFD*)cpu)->RES_ADDR = -1LL;\n";
cp.code() += "etiss_coverage_count(2, 8421, 8418);\n";
cp.code() += "} // block\n";
} // block
cp.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
cp.code() += "cpu->instructionPointer = cpu->nextPc;\n";
