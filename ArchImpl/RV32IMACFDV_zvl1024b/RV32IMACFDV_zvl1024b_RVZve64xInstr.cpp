...
cp.code() += "etiss_uint32 ret = etiss_vload_encoded_unitstride(cpu, system, plugin_pointers, ((RV32IMACFDV_zvl1024b*)cpu)->V, _vtype, " + std::to_string(vm) + "ULL, _eew, " + std::to_string(vd) + "ULL, _vstart, _vlen, _vl, (etiss_uint64)(*((RV32IMACFDV_zvl1024b*)cpu)->X[" + std::to_string(rs1) + "ULL]));\n";
...
cp.code() += "etiss_uint32 _vl = *((RV32IMACFDV_zvl1024b*)cpu)->CSR[3104ULL];\n";
cp.code() += "etiss_uint32 _vlen = *((RV32IMACFDV_zvl1024b*)cpu)->CSR[3106ULL] * 8ULL;\n";
cp.code() += "etiss_uint32 ret = etiss_vstore_encoded_unitstride(cpu, system, plugin_pointers, ((RV32IMACFDV_zvl1024b*)cpu)->V, _vtype, " + std::to_string(vm) + "ULL, _eew, " + std::to_string(vs3) + "ULL, _vstart, _vlen, _vl, (etiss_uint64)(*((RV32IMACFDV_zvl1024b*)cpu)->X[" + std::to_string(rs1) + "ULL]));\n";
cp.code() += "if (ret != 0LL) { // conditional\n";
{ // block
cp.code() += "{ // block\n";
cp.code() += "*((RV32IMACFDV_zvl1024b*)cpu)->CSR[8ULL] = ret >> 8ULL;\n";
