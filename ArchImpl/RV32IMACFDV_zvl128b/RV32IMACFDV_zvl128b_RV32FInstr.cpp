...
{ // block
cp.code() += "{ // block\n";
cp.code() += "*((RV32IMACFDV_zvl128b*)cpu)->F[" + std::to_string(rd) + "ULL] = ((((((*((RV32IMACFDV_zvl128b*)cpu)->F[" + std::to_string(rs2) + "ULL]) >> (31ULL)) & 1ULL)) << 31) | ((((*((RV32IMACFDV_zvl128b*)cpu)->F[" + std::to_string(rs1) + "ULL]) >> (0LL)) & 2147483647ULL)));\n";
cp.code() += "} // block\n";
} // block
cp.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
cp.code() += "cpu->instructionPointer = cpu->nextPc;\n";
