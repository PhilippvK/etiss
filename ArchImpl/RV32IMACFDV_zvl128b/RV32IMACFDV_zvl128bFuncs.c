...
{
{ // block
return (*((RV32IMACFDV_zvl128b*)cpu)->CSR[769LL] >> (extension - 65ULL)) & 1ULL;
} // block
}
...
rm = ((((((RV32IMACFDV_zvl128b*)cpu)->FCSR) >> (5ULL)) & 7ULL)) & 0x7;
} // conditional
if (rm > 4ULL) { // conditional
RV32IMACFDV_zvl128b_raise(cpu, system, plugin_pointers, 0LL, 2LL);
} // conditional
return rm;
} // block
}
...
if ((RV32IMACFDV_zvl128b_get_field(*((RV32IMACFDV_zvl128b*)cpu)->CSR[384LL], 2147483648ULL))) { // conditional
mask = mask | 262144LL;
} // conditional
} // block
} // conditional
...
return *((RV32IMACFDV_zvl128b*)cpu)->CSR[3LL] & 31ULL;
} // conditional
if (csr == 2LL) { // conditional
return (*((RV32IMACFDV_zvl128b*)cpu)->CSR[3LL] >> 5ULL) & 7ULL;
} // conditional
...
return *((RV32IMACFDV_zvl128b*)cpu)->CSR[768LL] | 8589934592ULL | 34359738368ULL;
} // conditional
if (csr == 769LL) { // conditional
return (((1ULL) << 30) | ((((*((RV32IMACFDV_zvl128b*)cpu)->CSR[769LL]) >> (0LL)) & 1073741823ULL)));
} // conditional
...
{ // block
if (csr == 1LL) { // conditional
*((RV32IMACFDV_zvl128b*)cpu)->CSR[3LL] = (*((RV32IMACFDV_zvl128b*)cpu)->CSR[3LL] & 224ULL) | (val & 31ULL);
} // conditional
 else if (csr == 2LL) { // conditional
*((RV32IMACFDV_zvl128b*)cpu)->CSR[3LL] = ((val & 7ULL) << 5ULL) | (*((RV32IMACFDV_zvl128b*)cpu)->CSR[3LL] & 31ULL);
} // conditional
 else if (csr == 3LL) { // conditional
*((RV32IMACFDV_zvl128b*)cpu)->CSR[3LL] = val & 255ULL;
} // conditional
 else if (csr == 768LL) { // conditional
*((RV32IMACFDV_zvl128b*)cpu)->CSR[768LL] = val & RV32IMACFDV_zvl128b_mstatus_mask(cpu, system, plugin_pointers);
} // conditional
 else if (csr == 256LL) { // conditional
*((RV32IMACFDV_zvl128b*)cpu)->CSR[768LL] = val & RV32IMACFDV_zvl128b_sstatus_mask(cpu, system, plugin_pointers);
} // conditional
...
if (irq2) { // conditional
{ // block
deleg = ((((RV32IMACFDV_zvl128b*)cpu)->PRIV <= 1LL)) ? (*((RV32IMACFDV_zvl128b*)cpu)->CSR[771LL]) : (0LL);
bit = bit & 2147483647ULL;
} // block
} // conditional
else { // conditional
{ // block
deleg = ((((RV32IMACFDV_zvl128b*)cpu)->PRIV <= 1LL)) ? (*((RV32IMACFDV_zvl128b*)cpu)->CSR[770LL]) : (0LL);
} // block
} // conditional
if (((RV32IMACFDV_zvl128b*)cpu)->PRIV <= 1LL && (deleg >> bit) & 1ULL) { // conditional
{ // block
vector = ((*((RV32IMACFDV_zvl128b*)cpu)->CSR[261LL] & 1ULL) && irq2) ? (bit * 4ULL) : (0LL);
cpu->nextPc = (*((RV32IMACFDV_zvl128b*)cpu)->CSR[261LL] & -2LL) + vector;
*((RV32IMACFDV_zvl128b*)cpu)->CSR[321LL] = epc;
*((RV32IMACFDV_zvl128b*)cpu)->CSR[322LL] = mcause;
etiss_uint32 s = RV32IMACFDV_zvl128b_csr_read(cpu, system, plugin_pointers, 256LL);
s = RV32IMACFDV_zvl128b_set_field(s, 32LL, RV32IMACFDV_zvl128b_get_field(s, 2LL));
s = RV32IMACFDV_zvl128b_set_field(s, 256LL, ((RV32IMACFDV_zvl128b*)cpu)->PRIV);
s = RV32IMACFDV_zvl128b_set_field(s, 2LL, 0LL);
RV32IMACFDV_zvl128b_csr_write(cpu, system, plugin_pointers, 256LL, s);
((RV32IMACFDV_zvl128b*)cpu)->PRIV = (1LL) & 0x7;
} // block
} // conditional
else { // conditional
{ // block
vector = ((*((RV32IMACFDV_zvl128b*)cpu)->CSR[773LL] & 1ULL) && irq2) ? (bit * 4ULL) : (0LL);
cpu->nextPc = (*((RV32IMACFDV_zvl128b*)cpu)->CSR[773LL] & -2LL) + vector;
*((RV32IMACFDV_zvl128b*)cpu)->CSR[833LL] = epc;
*((RV32IMACFDV_zvl128b*)cpu)->CSR[834LL] = mcause;
etiss_uint32 s = RV32IMACFDV_zvl128b_csr_read(cpu, system, plugin_pointers, 768LL);
s = RV32IMACFDV_zvl128b_set_field(s, 128LL, RV32IMACFDV_zvl128b_get_field(s, 8LL));
s = RV32IMACFDV_zvl128b_set_field(s, 6144LL, ((RV32IMACFDV_zvl128b*)cpu)->PRIV);
s = RV32IMACFDV_zvl128b_set_field(s, 8LL, 0LL);
RV32IMACFDV_zvl128b_csr_write(cpu, system, plugin_pointers, 768LL, s);
((RV32IMACFDV_zvl128b*)cpu)->PRIV = (3LL) & 0x7;
} // block
} // conditional
} // block
}
...
{
{ // block
etiss_uint32 pending_interrupts = *((RV32IMACFDV_zvl128b*)cpu)->CSR[772LL] & *((RV32IMACFDV_zvl128b*)cpu)->CSR[836LL];
if (!(pending_interrupts)) { // conditional
return 0LL;
} // conditional
etiss_uint32 mie = RV32IMACFDV_zvl128b_get_field(*((RV32IMACFDV_zvl128b*)cpu)->CSR[768LL], 8LL);
etiss_uint32 m_enabled = ((RV32IMACFDV_zvl128b*)cpu)->PRIV < 3LL || (((RV32IMACFDV_zvl128b*)cpu)->PRIV == 3LL && mie);
etiss_uint32 enabled_interrupts = pending_interrupts & ~(*((RV32IMACFDV_zvl128b*)cpu)->CSR[771LL]) & -(m_enabled);
if (enabled_interrupts == 0LL) { // conditional
{ // block
etiss_uint32 deleg = *((RV32IMACFDV_zvl128b*)cpu)->CSR[771LL];
etiss_uint32 sie = RV32IMACFDV_zvl128b_get_field(RV32IMACFDV_zvl128b_csr_read(cpu, system, plugin_pointers, 256LL), 2LL);
etiss_uint32 s_enabled = ((RV32IMACFDV_zvl128b*)cpu)->PRIV < 1LL || (((RV32IMACFDV_zvl128b*)cpu)->PRIV == 1LL && sie);
