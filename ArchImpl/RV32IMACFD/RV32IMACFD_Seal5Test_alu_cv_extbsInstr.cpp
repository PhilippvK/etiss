 ...
 *
 * This file contains the instruction behavior models of the Seal5Test_alu_cv_extbs
...
{ // block
cp.code() += "{ // block\n";
cp.code() += "*((RV32IMACFD*)cpu)->X[" + std::to_string(rd) + "ULL] = (etiss_int8)(((((*((RV32IMACFD*)cpu)->X[" + std::to_string(rs1) + "ULL]) >> (0LL)) & 255)));\n";
cp.code() += "} // block\n";
} // block
} // conditional
