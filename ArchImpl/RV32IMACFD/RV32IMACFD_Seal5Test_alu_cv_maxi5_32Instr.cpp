 ...
 *
 * This file contains the instruction behavior models of the Seal5Test_alu_cv_maxi5_32
...
// cv_maxi5_32 -----------------------------------------------------------------
static InstructionDefinition cv_maxi5_32_rd_rs1_imm5 (
	ISA32_RV32IMACFD,
	"cv_maxi5_32",
	(uint32_t) 0x1400007b,
	(uint32_t) 0xfe00707f,
...
// -----------------------------------------------------------------------------

	{
		...
		cp.code() = std::string("//cv_maxi5_32\n");
...
// -----------------------------------------------------------------------------
		...
		std::stringstream ss;
// -----------------------------------------------------------------------------
ss << "cv_maxi5_32" << " # " << ba << (" [rd=" + std::to_string(rd) + " | rs1=" + std::to_string(rs1) + " | imm5=" + std::to_string(imm5) + "]");
// -----------------------------------------------------------------------------
		return ss.str();
	}
);
