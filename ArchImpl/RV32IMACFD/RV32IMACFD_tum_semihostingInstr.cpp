...
cp.code() += "etiss_coverage_count(6, 2199, 2198, 2196, 2195, 2193, 2194);\n";
...
cp.code() += "etiss_coverage_count(6, 2208, 2207, 2205, 2204, 2202, 2203);\n";
...
cp.code() += "etiss_coverage_count(6, 2217, 2216, 2214, 2213, 2211, 2212);\n";
cp.code() += "etiss_coverage_count(1, 2218);\n";
cp.code() += "if (pre == 32509971ULL && ebreak == 1048691ULL && post == 1081102355ULL) { // conditional\n";
cp.code() += "etiss_coverage_count(11, 2229, 2225, 2221, 2219, 2220, 2224, 2222, 2223, 2228, 2226, 2227);\n";
{ // block
...
{ // block
cp.code() += "etiss_coverage_count(1, 2254);\n";
cp.code() += "{ // block\n";
{ // procedure
cp.code() += "{ // procedure\n";
...
cp.code() += "else { // conditional\n";
{ // block
cp.code() += "etiss_coverage_count(1, 2259);\n";
cp.code() += "{ // block\n";
{ // procedure
cp.code() += "{ // procedure\n";
cp.code() += "RV32IMACFD_raise(cpu, system, plugin_pointers, 0LL, 3LL);\n";
