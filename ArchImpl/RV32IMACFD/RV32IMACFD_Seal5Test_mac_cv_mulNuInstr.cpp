...
{ // block
cp.code() += "{ // block\n";
cp.code() += "*((RV32IMACFD*)cpu)->X[" + std::to_string(rd) + "ULL] = (etiss_uint16)(((((*((RV32IMACFD*)cpu)->X[" + std::to_string(rs1) + "ULL])) >> (0ULL)) & 65535)) * (etiss_uint16)(((((*((RV32IMACFD*)cpu)->X[" + std::to_string(rs2) + "ULL])) >> (0ULL)) & 65535)) >> " + std::to_string((etiss_uint8)((Is3))) + "ULL;\n";
cp.code() += "} // block\n";
} // block
} // conditional
