 ...
 *
 * This file contains the instruction behavior models of the Seal5Test_alu_cv_mini12_16
...
// cv_mini12_16 ----------------------------------------------------------------
static InstructionDefinition cv_mini12_16_rd_rs1_imm5 (
	ISA32_RV32IMACFD,
	"cv_mini12_16",
	(uint32_t) 0x00107b,
	(uint32_t) 0x00707f,
...
// -----------------------------------------------------------------------------

	{
		...
		cp.code() = std::string("//cv_mini12_16\n");
...
// -----------------------------------------------------------------------------
		...
		std::stringstream ss;
// -----------------------------------------------------------------------------
ss << "cv_mini12_16" << " # " << ba << (" [rd=" + std::to_string(rd) + " | rs1=" + std::to_string(rs1) + " | imm5=" + std::to_string(imm5) + "]");
// -----------------------------------------------------------------------------
		return ss.str();
	}
);
