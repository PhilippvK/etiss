 ...
 *
 * This file contains the instruction behavior models of the Seal5Test_alu_cv_min_u_32
...
// cv_min_u_32 -----------------------------------------------------------------
static InstructionDefinition cv_min_u_32_rd_rs1_rs2 (
	ISA32_RV32IMACFD,
	"cv_min_u_32",
	(uint32_t) 0x1e00007b,
	(uint32_t) 0xfe00707f,
...
// -----------------------------------------------------------------------------

	{
		...
		cp.code() = std::string("//cv_min_u_32\n");
...
// -----------------------------------------------------------------------------
		...
		std::stringstream ss;
// -----------------------------------------------------------------------------
ss << "cv_min_u_32" << " # " << ba << (" [rd=" + std::to_string(rd) + " | rs1=" + std::to_string(rs1) + " | rs2=" + std::to_string(rs2) + "]");
// -----------------------------------------------------------------------------
		return ss.str();
	}
);
