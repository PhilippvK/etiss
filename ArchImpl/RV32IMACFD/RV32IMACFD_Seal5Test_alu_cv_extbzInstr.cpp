 ...
 *
 * This file contains the instruction behavior models of the Seal5Test_alu_cv_extbz
...
{ // block
cp.code() += "{ // block\n";
cp.code() += "*((RV32IMACFD*)cpu)->X[" + std::to_string(rd) + "ULL] = (etiss_uint8)(((((*((RV32IMACFD*)cpu)->X[" + std::to_string(rs1) + "ULL]) >> (0ULL)) & 255)));\n";
cp.code() += "} // block\n";
} // block
} // conditional
